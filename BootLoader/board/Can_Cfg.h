...
#define CAN_INDEX                      (0)
/**
* @brief        This parameter describes the period for cyclic call to Can_MainFunction_Busoff.
*    Unit is seconds.
*
* @ref          ECUC_Can_00355
* @scope
*/
#define CAN_MAIN_FUNCTION_BUSOFF_PERIOD        (0.001)
/**
...
* @scope         LOCAL
*/
#define CAN_MAIN_FUNCTION_RW_PERIOD    (0.001)
 ...
 */
#define FLEXCAN_0_RX_PROCESS_HAS_INTERRUPT      (STD_OFF)
#define FLEXCAN_0_RX_PROCESS_HAS_POLLING        (STD_ON)
#define FLEXCAN_0_TX_PROCESS_HAS_INTERRUPT      (STD_OFF)
#define FLEXCAN_0_TX_PROCESS_HAS_POLLING        (STD_ON)
#define FLEXCAN_0_BUSOFF_PROCESS_HAS_INTERRUPT  (STD_OFF)
 ...
 */
#define CAN_RX_PROCESS_HAS_INTERRUPT      (STD_OFF)
#define CAN_RX_PROCESS_HAS_POLLING        (STD_ON)
#define CAN_TX_PROCESS_HAS_INTERRUPT      (STD_OFF)
#define CAN_TX_PROCESS_HAS_POLLING        (STD_ON)
#define CAN_BUSOFF_PROCESS_HAS_INTERRUPT  (STD_OFF)
#define CAN_BUSOFF_PROCESS_HAS_POLLING    (STD_ON)

#define CAN_FD_USAGE                      (STD_ON)
...
#define CAN_0_RX_PROCESS_MODE                 (CAN_EVENT_PROCESS_POLLING)
#define CAN_0_TX_PROCESS_MODE                 (CAN_EVENT_PROCESS_POLLING)
#define CAN_0_BUSOFF_PROCESS_MODE             (CAN_EVENT_PROCESS_POLLING)
