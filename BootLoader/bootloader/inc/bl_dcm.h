 ...
 *      05.02.00 | 27/03/2016 | beibei.xing      | N/A | BootSpec050006
 *
 *****************************************************************************/
#ifndef _BL_DCM_H_
#define _BL_DCM_H_
...
struct _tag_DcmServiceHeader
{
    ...
    bl_BufferSize_t (*MakeId)(bl_Buffer_t *buffer, bl_u16_t *id);
};
...
/**Dcm clear suspress positive response bit.*/
extern void Dcm_AllowPositiveResp(void);
