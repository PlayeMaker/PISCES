 ...
 *****************************************************************************/
extern bl_HashContext_t gs_HNSHashContext;
/*****************************************************************************
 *  External Function Prototype Declarations
 *****************************************************************************/
/** \brief Initialize the logical block module.*/
extern bl_Return_t Lbm_Init(void);
/** \brief Check requested download address and size whether in valid block.*/
extern bl_Return_t Lbm_CheckDownloadBlock(bl_Address_t address,
                              bl_Size_t size);
...
#endif
extern void Lbm_ClearFlashDriver(void);
#endif
