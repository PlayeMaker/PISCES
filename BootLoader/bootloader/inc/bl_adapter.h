 ...
 *      05.07.00 | 25/06/2021 | yatai.liu        | N/A | Boot050703
 *
 *****************************************************************************/
...
/** \brief Check download segment.*/
extern bl_Return_t Adpt_CheckDownloadSegment(bl_DownContext_t *dct,
                                             bl_Address_t address,
                                             bl_Size_t size);
/** \brief Check download range.*/
extern bl_Return_t Adpt_CheckDownloadRange(bl_Address_t address,
                                           bl_Size_t size);
