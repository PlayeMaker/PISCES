...
#define MEM_MEMORY_0_BASE_ADDRESS   (0x1FFF0000UL)
#define MEM_MEMORY_0_SIZE           (0x00010000UL)
...
#define MEM_MEMORY_1_BASE_ADDRESS   (0x00018000UL)
#define MEM_MEMORY_1_SIZE           (0x00068000UL)
...
#define MEM_MEMORY_2_OPS_WRITE      (&Dflash_Write)
#define MEM_MEMORY_2_OPS_READ       (&Dflash_Read)
#define MEM_MEMORY_2_OPS_ERASE      (&Dflash_Erase)
