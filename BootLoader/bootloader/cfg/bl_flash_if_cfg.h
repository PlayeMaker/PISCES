...
#define FLASHIF_ACCESS_TIMELIMITE           (1500UL) /*unit ms*/

/* define the physical flash block num*/
#define FLASHIF_ERASED_VALUE                (0xffu)

/* config order :address low-high*/
/* config block 0 parameter - 0x0000_6000-0x0007_EFFF */
#define FLASHIF_BLOCK0_STARTADDRESS         (0x00018000UL)
#define FLASHIF_BLOCK0_TOTAL_SIZE           (0x00068000UL)
#define FLASHIF_BLOCK0_SECTOR_SIZE          (0x200UL)

#define FLASHIF_BLOCK0_PAGE_SIZE            (8)

#define FLASHIF_MAX_PAGE_SIZE   FLASHIF_BLOCK0_PAGE_SIZE
