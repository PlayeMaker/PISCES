 ...
 */
#define HNS_DECOMPRESSED_DATA_BUFFER_SIZE         (32)
#define HNS_HASH_ALGORITHM_ID                     (SECM_HASH_SHA256)
#define HNS_SEGMENT_HASH_LENGTH                   (SECM_SHA256_HASH_LENGTH)
#define HNS_PUBLICKEY_HASH_LENGTH                 (SECM_SHA256_HASH_LENGTH)

#define LBM_HASH_CALCULATION_BUFFER_SIZE    (512UL)
#define LBM_HASH_CALCULATION_TIME           (2UL)
#define LBM_HASH_CALCULATION_TIMEOUT        (70400UL) /*ms*/
...
#define LBM_LB0_ERASE_MASK          RTE_SYSFLAG_INIT_FLASH_DRIVER
#define LBM_LB0_VERIFY_MASK         (0x00000000UL)
#define LBM_LB0_ADDRESS             (0x00018000UL)
#define LBM_LB0_SIZE                (0x00068000UL)
#define LBM_LB0_OFFSET_MASK         (0xFFFFFFFFUL)
#define LBM_LB0_VALID_FLAG_ID       (0x1u)
#define LBM_LB0_FILE_HEADER_ID      DM_ERROR_DATAID
#define LBM_LB0_FINGERPRINT_ID      DM_ERROR_DATAID
#define LBM_LB0_SUCCESS_COUNT_ID    DM_ERROR_DATAID
#define LBM_LB0_ATTEMPT_COUNT_ID    DM_ERROR_DATAID
#define LBM_LB0_MAX_ATTEMPT_COUNT   LBM_INVALID_ATTEMPT_COUNT
...
#define LBM_LB1_ADDRESS             (0x1FFFF000UL)
#define LBM_LB1_SIZE                (0x00000A00UL)
...
#define LBM_LB1_MAX_ATTEMPT_COUNT   LBM_INVALID_ATTEMPT_COUNT
#define LBM_LB1_SEG_NUMBER          (0)
#define LBM_LB1_SEG_PTR             BL_NULL_PTR


#define LBM_DRIVER_ADDRESS          LBM_LB1_ADDRESS
#define LBM_DRIVER_size             LBM_LB1_SIZE


#define LBM_TYPE_DRIVER_LBID        (1)
/*****************************************************************************
 *  Type Declarations
 *****************************************************************************/
...
extern bl_Size_t Backup_totalSize;
/*****************************************************************************
