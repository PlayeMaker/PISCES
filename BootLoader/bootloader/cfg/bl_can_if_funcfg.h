...
/* MCMD */
#define CANIF_PHY_RX_CANID                  (0x00000623UL)
#define CANIF_PHY_TX_CANID                  (0x000006A3UL)
/* MCMP */
/*********************************************************
 * CANIF_PHY_RX_CANID------------------------0x624
 * CANIF_PHY_TX_CANID------------------------0x6A4
 * ******************************************************/


#define CANIF_FUN_RX_CANID                  (0x00000601UL)
