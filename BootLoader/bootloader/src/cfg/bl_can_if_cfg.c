...
#else
bl_CanIfPduCfg_t gs_CanIfPduCfg[CANIF_NUMBER_OF_PDU] =
{
    {
        CANIF_RECEIVE, CANIF_STANDARD, HANDLE_CAN0_RX0, CANIF_PHY_RX_CANID
    },
    {
        CANIF_RECEIVE, CANIF_STANDARD, HANDLE_CAN0_RX1, CANIF_FUN_RX_CANID
    },
    {
        CANIF_TRANSMITE, CANIF_STANDARD, HANDLE_CAN0_TX0,CANIF_PHY_TX_CANID
    },
...
bl_CanIfRxList_t g_CanIfRxPduCfg =
{
    CANIFRX_TOTAL_NUM,&gs_CanIfPduCfg[0],&Cantp_RxIndication,
};

bl_CanIfTxList_t g_CanIfTxPduCfg =
{
