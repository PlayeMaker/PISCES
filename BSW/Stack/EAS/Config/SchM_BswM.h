...
#define SchM_Enter_BswM_BSWM_EXCLUSIVE_AREA_1()
#define SchM_Exit_BswM_BSWM_EXCLUSIVE_AREA_1()


#define SchM_Enter_BswM_BSWM_EXCLUSIVE_AREA_2()
#define SchM_Exit_BswM_BSWM_EXCLUSIVE_AREA_2()
