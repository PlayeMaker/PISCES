 ...
 *      05.02.00 | 10/09/2019 | lele.liu         | N/A | BootSpec050021
 *      05.07.00 | 23/08/2021 | yatai.liu        | N/A | Boot050712
 *
 *****************************************************************************/
...
#define BL_DEBUG_XMIT(str)
#define BL_ASSERT(cond, string)         do{\
                                            if (!(cond))\
                                            {\
                                                BL_DEBUG_XMIT(string);\
                                                while (1);\
                                            }\
                                        } while(0) /*lint !e717*/
...
typedef bl_u8_t bl_CanHandle_t;
...
typedef enum _tag_Return
{
    ...
    /** The address and/or size is out of logical block.*/
    BL_ERR_LB_OUTOFRANGE = 13,
    /** The Flash Driver is not initialized.*/
    BL_ERR_MEMORYDRIVER_UNINIT = 14,
    /** The can driver is busy*/
    BL_ERR_CAN_BUSY = 15,
