...
#define SECM_SIGNATURE_INIT()                           Sign_Init()
#define SECM_SIGNATURE_VERIFY(id, hs, h, ss, s)         Sign_VerifySignature(id, hs, h, ss, s)
#define SECM_SIGNATURE_UPDATE_PUBLICKEY(key, size)      Sign_UpdatePublicKey(key, size)
/*****************************************************************************
 *  Type Declarations
 *****************************************************************************/
...
extern const bl_HashOperations_t g_HashOperations[];
/*****************************************************************************
