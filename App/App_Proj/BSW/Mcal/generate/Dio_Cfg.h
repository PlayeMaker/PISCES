 ...
 */
/** @{ */
#define DioConf_DioPort_PORTA (0x0U)
#define DioConf_DioPort_PORTB (0x1U)
#define DioConf_DioPort_PORTC (0x2U)
#define DioConf_DioPort_PORTD (0x3U)
#define DioConf_DioPort_PORTE (0x4U)
 ...
 */
/** @{ */
#define DioConf_DioChannel_HEAT3_EN        (((0U << 8U) + 6U))
#define DioConf_DioChannel_HEAT4_EN        (((0U << 8U) + 7U))
#define DioConf_DioChannel_HEAT_EN        (((1U << 8U) + 3U))
#define DioConf_DioChannel_HEAT1_EN        (((1U << 8U) + 13U))
#define DioConf_DioChannel_BAT_VOL_AD_EN        (((1U << 8U) + 12U))
#define DioConf_DioChannel_CAN_STB        (((2U << 8U) + 9U))
#define DioConf_DioChannel_HEAT5_EN        (((2U << 8U) + 8U))
#define DioConf_DioChannel_PUMP_VALVE_DSEL        (((2U << 8U) + 5U))
#define DioConf_DioChannel_EN_5V_LOAD        (((3U << 8U) + 3U))
#define DioConf_DioChannel_HEAT2_EN        (((4U << 8U) + 7U))
#define DioConf_DioChannel_PUMP_EN2        (((4U << 8U) + 1U))
#define DioConf_DioChannel_VALVE_EN        (((4U << 8U) + 0U))
/** @} */
