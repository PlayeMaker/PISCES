...
/** \brief If the check of flash erase/write address is done in bootloader, enable it.*/
#define FLASHIF_FUN_CHECKADDR_IN_BOOT       BL_FUN_ON

#define FLASHIF_DRIVER_STARTADDRESS         (0x1FFFF000UL)
#define FLASHIF_DRIVER_MAGIC_VALUE          (0x58455031UL)
#define FLASHIF_DRIVER_VERSION_VALUE        (0x00010300UL)
#define FLASHIF_DRIVER_START_VALUE          (0x80U)
