...
STATIC CONST(boolean, DCM_CONST) Dcm_DsdSubServiceUsed_PB0_STAB0[17U] = {TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE};
STATIC CONST(boolean, DCM_CONST) Dcm_DsdServiceUsed_PB1_STAB0[10U] = {TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE};
STATIC CONST(boolean, DCM_CONST) Dcm_DsdSubServiceUsed_PB1_STAB0[17U] = {TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE};

STATIC CONST(boolean, DCM_CONST) Dcm_DspDidUsed_PB0_STAB0[14U] = {TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE};
STATIC CONST(boolean, DCM_CONST) Dcm_DspDidUsed_PB1_STAB0[14U] = {TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE};

STATIC CONST(boolean, DCM_CONST) Dcm_DspRoutineUsed_PB0_STAB0[1U] = {TRUE};
STATIC CONST(boolean, DCM_CONST) Dcm_DspRoutineUsed_PB1_STAB0[1U] = {TRUE};
