...
#define LUMBAR_TOP_CHANNEL_FRONT RTE_PWM_CHANNEL_YTR2
#define LUMBAR_TOP_CHANNEL_REAR  RTE_PWM_CHANNEL_YT2
#define LUMBAR_BOTTOM_CHANNEL_FRONT RTE_PWM_CHANNEL_YT1
#define LUMBAR_BOTTOM_CHANNEL_REAR  RTE_PWM_CHANNEL_YTR1
#endif
/************************ Type Definitions ************************/
