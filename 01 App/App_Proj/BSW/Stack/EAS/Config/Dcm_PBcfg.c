...
STATIC CONST(boolean, DCM_CONST) Dcm_DspDidUsed_PB0_STAB0[19U] = {TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE};
STATIC CONST(boolean, DCM_CONST) Dcm_DspDidUsed_PB1_STAB0[19U] = {TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE};
