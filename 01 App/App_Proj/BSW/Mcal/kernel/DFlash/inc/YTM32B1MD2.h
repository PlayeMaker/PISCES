/*
** ###################################################################
**     Processor:           YTM32B1MD2
**     Version:             rev. 1.0, 2025-08-13
**
**     Abstract:
**         Peripheral Access Layer for YTM32B1MD2
**
 ...
 * @version 1.0
 * @date 2025-08-13
 * @brief Peripheral Access Layer for YTM32B1MD2
 *
...
#ifndef YTM32B1MD2_H  /* Check if memory map has not been already included */
#define YTM32B1MD2_H
#define MCU_YTM32B1MD2

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error YTM32B1MD2 memory map: There is already included another memory map. Only one memory map can be included.
...
#endif
/* ----------------------------------------------------------------------------
   -- Interrupt vector numbers for YTM32B1MD2
   ---------------------------------------------------------------------------- */
...
/*!
 * @}
 */ /* end of group Interrupt_vector_numbers YTM32B1MD2 */
...
#include "system_YTM32B1MD2.h"                              /* System Header */
...
#endif
/* ----------------------------------------------------------------------------
   -- Device Peripheral Access Layer for YTM32B1MD2
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup Peripheral_access_layer_YTM32B1MD2 Device Peripheral Access Layer for YTM32B1MD2
 * @{
 */
...
typedef struct {
    ...
    __IO uint32_t ADDR_PROT[ 3];                                              /**< Flash Partition Protect Register, offset: 0x0024 */
    __IO uint32_t ECCERR_ADDR;                                                /**< ECC Error Address, offset: 0x0030 */
    __IO uint32_t ECCERR_CNT;                                                 /**< ECC Error Count, offset: 0x0034 */
    __IO uint8_t  RESERVED11[200];                                            /**< RESERVED11, offset: 0x0038 */
    __IO uint32_t RSA_KEY_CFG;                                                /**< RSA_KEY Config, offset: 0x0100 */
    __IO uint8_t  RESERVED13[252];                                            /**< RESERVED13, offset: 0x0104 */
    __O  uint32_t CMD_UNLOCK;                                                 /**< EFM Command Unlock, offset: 0x0200 */
    __IO uint32_t CUS_KEY;                                                    /**< EFM Customer Key, offset: 0x0204 */
    __IO uint8_t  RESERVED16[248];                                            /**< RESERVED16, offset: 0x0208 */
    __IO uint32_t CTRL_OVRD;                                                  /**< Override Control Register, offset: 0x0300 */
    __IO uint32_t RESERVED18;                                                 /**< RESERVED18, offset: 0x0304 */
    __IO uint32_t RESERVED19;                                                 /**< RESERVED19, offset: 0x0308 */
    __IO uint8_t  RESERVED20[116];                                            /**< RESERVED20, offset: 0x030C */
    __IO uint32_t RESERVED21;                                                 /**< RESERVED21, offset: 0x0380 */
    __IO uint32_t RESERVED22;                                                 /**< RESERVED22, offset: 0x0384 */
...
#define EFM_TIMING1_TPROG_SEL(x)                                              (((uint32_t)(((uint32_t)(x)) << EFM_TIMING1_TPROG_SEL_SHIFT)) & EFM_TIMING1_TPROG_SEL_MASK)
/* EFM_TIMING2 Register */
#define EFM_TIMING2_TERASE_BLK_SEL_MASK                                       (0x30000U)
#define EFM_TIMING2_TERASE_BLK_SEL_SHIFT                                      (16U)
#define EFM_TIMING2_TERASE_BLK_SEL(x)                                         (((uint32_t)(((uint32_t)(x)) << EFM_TIMING2_TERASE_BLK_SEL_SHIFT)) & EFM_TIMING2_TERASE_BLK_SEL_MASK)
#define EFM_TIMING2_TERASE_SEC_SEL_MASK                                       (0x3U)
#define EFM_TIMING2_TERASE_SEC_SEL_SHIFT                                      (0U)
#define EFM_TIMING2_TERASE_SEC_SEL(x)                                         (((uint32_t)(((uint32_t)(x)) << EFM_TIMING2_TERASE_SEC_SEL_SHIFT)) & EFM_TIMING2_TERASE_SEC_SEL_MASK)
...
#define EFM_ECCERR_CNT_ECCERR_INJ_ST(x)                                       (((uint32_t)(((uint32_t)(x)) << EFM_ECCERR_CNT_ECCERR_INJ_ST_SHIFT)) & EFM_ECCERR_CNT_ECCERR_INJ_ST_MASK)
...
#define EFM_RSA_KEY_CFG_RSA_KEY_NUM(x)                                        (((uint32_t)(((uint32_t)(x)) << EFM_RSA_KEY_CFG_RSA_KEY_NUM_SHIFT)) & EFM_RSA_KEY_CFG_RSA_KEY_NUM_MASK)
...
#define EFM_CTRL_OVRD_DFLASH_PREREAD_DIS(x)                                   (((uint32_t)(((uint32_t)(x)) << EFM_CTRL_OVRD_DFLASH_PREREAD_DIS_SHIFT)) & EFM_CTRL_OVRD_DFLASH_PREREAD_DIS_MASK)
#define EFM_CTRL_OVRD_PFLASH_PREREAD_DIS_MASK                                 (0x20U)
#define EFM_CTRL_OVRD_PFLASH_PREREAD_DIS_SHIFT                                (5U)
#define EFM_CTRL_OVRD_PFLASH_PREREAD_DIS(x)                                   (((uint32_t)(((uint32_t)(x)) << EFM_CTRL_OVRD_PFLASH_PREREAD_DIS_SHIFT)) & EFM_CTRL_OVRD_PFLASH_PREREAD_DIS_MASK)
...
#define EFM_CTRL_OVRD_PFLASH_ECC_DIS(x)                                       (((uint32_t)(((uint32_t)(x)) << EFM_CTRL_OVRD_PFLASH_ECC_DIS_SHIFT)) & EFM_CTRL_OVRD_PFLASH_ECC_DIS_MASK)
...
typedef struct {
    __IO uint32_t CACR;                                                       /**< Cache Control Register, offset: 0x0000 */
    __IO uint32_t CALCR;                                                      /**< Cache Line Control Register, offset: 0x0004 */
    __IO uint32_t CASAR;                                                      /**< Cache Search Address Register, offset: 0x0008 */
    __IO uint32_t RESERVED3;                                                  /**< RESERVED3, offset: 0x000C */
    __IO uint8_t  RESERVED4[16];                                              /**< RESERVED4, offset: 0x0010 */
    __IO uint32_t CAMR;                                                       /**< Cache Mode Register, offset: 0x0020 */
    __IO uint8_t  RESERVED6[28];                                              /**< RESERVED6, offset: 0x0024 */
    __IO uint32_t CAPCR;                                                      /**< Cache Parity Control Register, offset: 0x0040 */
    __IO uint32_t CAPFISR;                                                    /**< Cache Parity Fault Interrupt Status Register, offset: 0x0044 */
    __I  uint32_t CAPFADDR;                                                   /**< Cache Parity Fault Address Register, offset: 0x0048 */
    __I  uint32_t CAPFATT;                                                    /**< Cache Parity Fault Attribute Register, offset: 0x004C */
    __I  uint32_t RESERVED11;                                                 /**< RESERVED11, offset: 0x0050 */
    __I  uint32_t CAPFDAT;                                                    /**< Cache Parity Fault DATA Register, offset: 0x0054 */
...
/* CACHE base address */
#define CACHE_BASE                                                            (0xE0080000U)
#define CACHE                                                                 ((CACHE_Type *)(CACHE_BASE))

/** Array initializer of CACHE peripheral base addresses */
#define CACHE_BASE_ADDRS                                                      { CACHE_BASE }
/** Array initializer of CACHE peripheral base pointers */
#define CACHE_BASE_PTRS                                                       { CACHE }
/** Number of interrupt vector arrays for the CACHE module. */
#define CACHE_IRQS_ARR_COUNT                                                  (1U)
/** Number of interrupt channels for the CACHE. */
#define CACHE_IRQS_CH_COUNT                                                   (1U)
/** Interrupt vectors for the CACHE peripheral type */
#define CACHE_IRQS                                                            { CACHE_IRQn }

/* CACHE Register Mask */
/* CACHE_CACR Register */
#define CACHE_CACR_CMDREQ_MASK                                                (0x80000000U)
#define CACHE_CACR_CMDREQ_SHIFT                                               (31U)
#define CACHE_CACR_CMDREQ(x)                                                  (((uint32_t)(((uint32_t)(x)) << CACHE_CACR_CMDREQ_SHIFT)) & CACHE_CACR_CMDREQ_MASK)
#define CACHE_CACR_IW1_MASK                                                   (0x4000000U)
#define CACHE_CACR_IW1_SHIFT                                                  (26U)
#define CACHE_CACR_IW1(x)                                                     (((uint32_t)(((uint32_t)(x)) << CACHE_CACR_IW1_SHIFT)) & CACHE_CACR_IW1_MASK)
#define CACHE_CACR_IW0_MASK                                                   (0x1000000U)
#define CACHE_CACR_IW0_SHIFT                                                  (24U)
#define CACHE_CACR_IW0(x)                                                     (((uint32_t)(((uint32_t)(x)) << CACHE_CACR_IW0_SHIFT)) & CACHE_CACR_IW0_MASK)
#define CACHE_CACR_EN_MASK                                                    (0x1U)
#define CACHE_CACR_EN_SHIFT                                                   (0U)
#define CACHE_CACR_EN(x)                                                      (((uint32_t)(((uint32_t)(x)) << CACHE_CACR_EN_SHIFT)) & CACHE_CACR_EN_MASK)
/* CACHE_CALCR Register */
#define CACHE_CALCR_LADDRS_MASK                                               (0x4000000U)
#define CACHE_CALCR_LADDRS_SHIFT                                              (26U)
#define CACHE_CALCR_LADDRS(x)                                                 (((uint32_t)(((uint32_t)(x)) << CACHE_CALCR_LADDRS_SHIFT)) & CACHE_CALCR_LADDRS_MASK)
#define CACHE_CALCR_LCMD_MASK                                                 (0x3000000U)
#define CACHE_CALCR_LCMD_SHIFT                                                (24U)
#define CACHE_CALCR_LCMD(x)                                                   (((uint32_t)(((uint32_t)(x)) << CACHE_CALCR_LCMD_SHIFT)) & CACHE_CALCR_LCMD_MASK)
#define CACHE_CALCR_LCMDW_MASK                                                (0x400000U)
#define CACHE_CALCR_LCMDW_SHIFT                                               (22U)
#define CACHE_CALCR_LCMDW(x)                                                  (((uint32_t)(((uint32_t)(x)) << CACHE_CALCR_LCMDW_SHIFT)) & CACHE_CALCR_LCMDW_MASK)
#define CACHE_CALCR_LCMDREQV_MASK                                             (0x100000U)
#define CACHE_CALCR_LCMDREQV_SHIFT                                            (20U)
#define CACHE_CALCR_LCMDREQV(x)                                               (((uint32_t)(((uint32_t)(x)) << CACHE_CALCR_LCMDREQV_SHIFT)) & CACHE_CALCR_LCMDREQV_MASK)
#define CACHE_CALCR_WS_MASK                                                   (0x4000U)
#define CACHE_CALCR_WS_SHIFT                                                  (14U)
#define CACHE_CALCR_WS(x)                                                     (((uint32_t)(((uint32_t)(x)) << CACHE_CALCR_WS_SHIFT)) & CACHE_CALCR_WS_MASK)
#define CACHE_CALCR_CAADDR_MASK                                               (0x3FF0U)
#define CACHE_CALCR_CAADDR_SHIFT                                              (4U)
#define CACHE_CALCR_CAADDR(x)                                                 (((uint32_t)(((uint32_t)(x)) << CACHE_CALCR_CAADDR_SHIFT)) & CACHE_CALCR_CAADDR_MASK)
#define CACHE_CALCR_LCMDREQ_MASK                                              (0x1U)
#define CACHE_CALCR_LCMDREQ_SHIFT                                             (0U)
#define CACHE_CALCR_LCMDREQ(x)                                                (((uint32_t)(((uint32_t)(x)) << CACHE_CALCR_LCMDREQ_SHIFT)) & CACHE_CALCR_LCMDREQ_MASK)
/* CACHE_CASAR Register */
#define CACHE_CASAR_PHYADDR_MASK                                              (0xFFFFFFF0U)
#define CACHE_CASAR_PHYADDR_SHIFT                                             (4U)
#define CACHE_CASAR_PHYADDR(x)                                                (((uint32_t)(((uint32_t)(x)) << CACHE_CASAR_PHYADDR_SHIFT)) & CACHE_CASAR_PHYADDR_MASK)
#define CACHE_CASAR_LCMDREQ_MASK                                              (0x1U)
#define CACHE_CASAR_LCMDREQ_SHIFT                                             (0U)
#define CACHE_CASAR_LCMDREQ(x)                                                (((uint32_t)(((uint32_t)(x)) << CACHE_CASAR_LCMDREQ_SHIFT)) & CACHE_CASAR_LCMDREQ_MASK)
/* CACHE_CAMR Register */
#define CACHE_CAMR_PFLASHCM_MASK                                              (0x80000000U)
#define CACHE_CAMR_PFLASHCM_SHIFT                                             (31U)
#define CACHE_CAMR_PFLASHCM(x)                                                (((uint32_t)(((uint32_t)(x)) << CACHE_CAMR_PFLASHCM_SHIFT)) & CACHE_CAMR_PFLASHCM_MASK)
#define CACHE_CAMR_OCRAMCM_MASK                                               (0x8000000U)
#define CACHE_CAMR_OCRAMCM_SHIFT                                              (27U)
#define CACHE_CAMR_OCRAMCM(x)                                                 (((uint32_t)(((uint32_t)(x)) << CACHE_CAMR_OCRAMCM_SHIFT)) & CACHE_CAMR_OCRAMCM_MASK)
/* CACHE_CAPCR Register */
#define CACHE_CAPCR_CAPREN_MASK                                               (0x4U)
#define CACHE_CAPCR_CAPREN_SHIFT                                              (2U)
#define CACHE_CAPCR_CAPREN(x)                                                 (((uint32_t)(((uint32_t)(x)) << CACHE_CAPCR_CAPREN_SHIFT)) & CACHE_CAPCR_CAPREN_MASK)
#define CACHE_CAPCR_CAPFEN_MASK                                               (0x2U)
#define CACHE_CAPCR_CAPFEN_SHIFT                                              (1U)
#define CACHE_CAPCR_CAPFEN(x)                                                 (((uint32_t)(((uint32_t)(x)) << CACHE_CAPCR_CAPFEN_SHIFT)) & CACHE_CAPCR_CAPFEN_MASK)
#define CACHE_CAPCR_CAPFBDIS_MASK                                             (0x1U)
#define CACHE_CAPCR_CAPFBDIS_SHIFT                                            (0U)
#define CACHE_CAPCR_CAPFBDIS(x)                                               (((uint32_t)(((uint32_t)(x)) << CACHE_CAPCR_CAPFBDIS_SHIFT)) & CACHE_CAPCR_CAPFBDIS_MASK)
/* CACHE_CAPFISR Register */
#define CACHE_CAPFISR_CATPERR_MASK                                            (0x2U)
#define CACHE_CAPFISR_CATPERR_SHIFT                                           (1U)
#define CACHE_CAPFISR_CATPERR(x)                                              (((uint32_t)(((uint32_t)(x)) << CACHE_CAPFISR_CATPERR_SHIFT)) & CACHE_CAPFISR_CATPERR_MASK)
#define CACHE_CAPFISR_CADPERR_MASK                                            (0x1U)
#define CACHE_CAPFISR_CADPERR_SHIFT                                           (0U)
#define CACHE_CAPFISR_CADPERR(x)                                              (((uint32_t)(((uint32_t)(x)) << CACHE_CAPFISR_CADPERR_SHIFT)) & CACHE_CAPFISR_CADPERR_MASK)
/* CACHE_CAPFADDR Register */
#define CACHE_CAPFADDR_CAPFADDR_MASK                                          (0xFFFFFFFFU)
#define CACHE_CAPFADDR_CAPFADDR_SHIFT                                         (0U)
#define CACHE_CAPFADDR_CAPFADDR(x)                                            (((uint32_t)(((uint32_t)(x)) << CACHE_CAPFADDR_CAPFADDR_SHIFT)) & CACHE_CAPFADDR_CAPFADDR_MASK)
/* CACHE_CAPFATT Register */
#define CACHE_CAPFATT_CAPFSIZE_MASK                                           (0x70U)
#define CACHE_CAPFATT_CAPFSIZE_SHIFT                                          (4U)
#define CACHE_CAPFATT_CAPFSIZE(x)                                             (((uint32_t)(((uint32_t)(x)) << CACHE_CAPFATT_CAPFSIZE_SHIFT)) & CACHE_CAPFATT_CAPFSIZE_MASK)
#define CACHE_CAPFATT_CAPFPROT_MASK                                           (0xFU)
#define CACHE_CAPFATT_CAPFPROT_SHIFT                                          (0U)
#define CACHE_CAPFATT_CAPFPROT(x)                                             (((uint32_t)(((uint32_t)(x)) << CACHE_CAPFATT_CAPFPROT_SHIFT)) & CACHE_CAPFATT_CAPFPROT_MASK)
/* CACHE_CAPFDAT Register */
#define CACHE_CAPFDAT_CAPFDAT_MASK                                            (0xFFFFFFFFU)
#define CACHE_CAPFDAT_CAPFDAT_SHIFT                                           (0U)
#define CACHE_CAPFDAT_CAPFDAT(x)                                              (((uint32_t)(((uint32_t)(x)) << CACHE_CAPFDAT_CAPFDAT_SHIFT)) & CACHE_CAPFDAT_CAPFDAT_MASK)
...
#define PCTRL_PCR_COUNT                                                       (18U)

/* PCTRL Register Layout Typedef */
typedef struct {
    __IO uint32_t PCR[18];                                                    /**< Port Control Register, offset: 0x0000 */
...
#define PCTRL_PCR_OCEN(x)                                                     (((uint32_t)(((uint32_t)(x)) << PCTRL_PCR_OCEN_SHIFT)) & PCTRL_PCR_OCEN_MASK)
...
#define DMA_CHMUX_COUNT                                                       (8U)
#define DMA_CTS_COUNT                                                         (8U)
...
typedef struct {
    ...
    __IO uint8_t  CHMUX[ 8];                                                  /**< Channel Mux Register, offset: 0x0040 */
    __IO uint8_t  RESERVED12[24];                                             /**< RESERVED12, offset: 0x0048 */
    __IO uint32_t REQSET;                                                     /**< DMA Channel Request Set Enable, offset: 0x0060 */
    __IO uint32_t REQCLR;                                                     /**< DMA Channel Request Clear Enable, offset: 0x0064 */
    __IO uint8_t  RESERVED15[920];                                            /**< RESERVED15, offset: 0x0068 */
    struct {
...
#define DMA_IRQS_ARR_COUNT                                                    (9U)
/** Number of interrupt channels for the channel done interrupt type of DMA. */
#define DMA_CHN_IRQS_CH_COUNT                                                 (8U)
#define DMA_CHN_IRQS                                                          { DMA0_IRQn, DMA1_IRQn, DMA2_IRQn, DMA3_IRQn, DMA4_IRQn, DMA5_IRQn, DMA6_IRQn, DMA7_IRQn }
...
#define DMA_CTRL_EBW(x)                                                       (((uint32_t)(((uint32_t)(x)) << DMA_CTRL_EBW_SHIFT)) & DMA_CTRL_EBW_MASK)
...
#define DMA_REQSET_CH(x)                                                      (((uint32_t)(((uint32_t)(x)) << DMA_REQSET_CH_SHIFT)) & DMA_REQSET_CH_MASK)
/* DMA_REQCLR Register */
#define DMA_REQCLR_CH_MASK                                                    (0xFFU)
#define DMA_REQCLR_CH_SHIFT                                                   (0U)
#define DMA_REQCLR_CH(x)                                                      (((uint32_t)(((uint32_t)(x)) << DMA_REQCLR_CH_SHIFT)) & DMA_REQCLR_CH_MASK)
...
// typedef struct {
//     __I  uint32_t DIEINFO;                                                    /**< Die Information Register, offset: 0x0000 */
//     __IO uint8_t  RESERVED1[ 4];                                              /**< RESERVED1, offset: 0x0004 */
//     __I  uint32_t CHIPINFO;                                                   /**< Chip Information Register, offset: 0x0008 */
//     __IO uint8_t  RESERVED3[36];                                              /**< RESERVED3, offset: 0x000C */
//     __IO uint32_t CTRL;                                                       /**< CIM Control Register, offset: 0x0030 */
//     __IO uint8_t  RESERVED5[12];                                              /**< RESERVED5, offset: 0x0034 */
//     __IO uint32_t FPUIE;                                                      /**< FPU Interrupt Enable Register, offset: 0x0040 */
//     __IO uint32_t SWTRIG;                                                     /**< Software Trigger Register, offset: 0x0044 */
//     __IO uint32_t ETMROPT0;                                                   /**< eTMR Option Register 0, offset: 0x0048 */
//     __IO uint32_t ETMROPT1;                                                   /**< eTMR Option Register 1, offset: 0x004C */
...
#define CIM_CHIPINFO_FLEXCAN2_EN(x)                                           (((uint32_t)(((uint32_t)(x)) << CIM_CHIPINFO_FLEXCAN2_EN_SHIFT)) & CIM_CHIPINFO_FLEXCAN2_EN_MASK)
...
typedef struct {
    ...
    __IO uint8_t  RESERVED7[ 4];                                              /**< RESERVED7, offset: 0x001C */
    __IO uint32_t PLL_CTRL;                                                   /**< PLL Control Register, offset: 0x0020 */
    __IO uint8_t  RESERVED9[12];                                              /**< RESERVED9, offset: 0x0024 */
    __IO uint32_t RESERVED10;                                                 /**< RESERVED10, offset: 0x0030 */
    __IO uint32_t RESERVED11;                                                 /**< RESERVED11, offset: 0x0034 */
    __IO uint32_t RESERVED12;                                                 /**< RESERVED12, offset: 0x0038 */
    __IO uint8_t  RESERVED13[44];                                             /**< RESERVED13, offset: 0x003C */
    __IO uint32_t RESERVED14;                                                 /**< RESERVED14, offset: 0x0068 */
...
#define CAN_RX_Warning_IRQS_CH_COUNT                                          (3U)
...
#define CAN_TX_Warning_IRQS_CH_COUNT                                          (3U)
...
#define CAN_Error_IRQS_CH_COUNT                                               (3U)
...
#define CAN_Bus_Off_IRQS_CH_COUNT                                             (3U)
...
#define CAN_Wake_Up_IRQS_CH_COUNT                                             (3U)
...
#define CAN_ORed_0_15_MB_IRQS_CH_COUNT                                        (3U)
...
#define CAN_ORed_16_31_MB_IRQS_CH_COUNT                                       (3U)
...
#define CAN_ORed_32_47_MB_IRQS                                                { CAN0_ORed_32_47_MB_IRQn, CAN1_ORed_32_47_MB_IRQn, NotAvail_IRQn }
/** Number of interrupt channels for the Mailbox buffer 48 - 64 type of CAN. */
#define CAN_ORed_48_63_MB_IRQS_CH_COUNT                                       (3U)
#define CAN_ORed_48_63_MB_IRQS                                                { CAN0_ORed_48_63_MB_IRQn, CAN1_ORed_48_63_MB_IRQn, NotAvail_IRQn }
...
#define UART_CTRL1_RBACK(x)                                                   (((uint32_t)(((uint32_t)(x)) << UART_CTRL1_RBACK_SHIFT)) & UART_CTRL1_RBACK_MASK)
...
#define UART_INTF_RBCEIF(x)                                                   (((uint32_t)(((uint32_t)(x)) << UART_INTF_RBCEIF_SHIFT)) & UART_INTF_RBCEIF_MASK)
...
#define UART_INTE_RBCEIE(x)                                                   (((uint32_t)(((uint32_t)(x)) << UART_INTE_RBCEIE_SHIFT)) & UART_INTE_RBCEIE_MASK)
...
#define SPI_STS_PCSPOSIF(x)                                                   (((uint32_t)(((uint32_t)(x)) << SPI_STS_PCSPOSIF_SHIFT)) & SPI_STS_PCSPOSIF_MASK)
#define SPI_STS_PCSNEGIF_MASK                                                 (0x100U)
#define SPI_STS_PCSNEGIF_SHIFT                                                (8U)
#define SPI_STS_PCSNEGIF(x)                                                   (((uint32_t)(((uint32_t)(x)) << SPI_STS_PCSNEGIF_SHIFT)) & SPI_STS_PCSNEGIF_MASK)
...
#define SPI_INTE_PCSPOSIE(x)                                                  (((uint32_t)(((uint32_t)(x)) << SPI_INTE_PCSPOSIE_SHIFT)) & SPI_INTE_PCSPOSIE_MASK)
#define SPI_INTE_PCSNEGIE_MASK                                                (0x100U)
#define SPI_INTE_PCSNEGIE_SHIFT                                               (8U)
#define SPI_INTE_PCSNEGIE(x)                                                  (((uint32_t)(((uint32_t)(x)) << SPI_INTE_PCSNEGIE_SHIFT)) & SPI_INTE_PCSNEGIE_MASK)
...
#define pTMR_MCR_CLK_SEL(x)                                                   (((uint32_t)(((uint32_t)(x)) << pTMR_MCR_CLK_SEL_SHIFT)) & pTMR_MCR_CLK_SEL_MASK)
...
typedef struct {
    ...
    __IO uint8_t  RESERVED20[48];                                             /**< RESERVED20, offset: 0x0050 */
    struct {
        ...
        __IO uint32_t RESERVEDS2110[ 6];                                      /**< RESERVEDS2110, offset: 0x00A8 */
...
#define eTMR_CH_CTRL_CENTER(x)                                                (((uint32_t)(((uint32_t)(x)) << eTMR_CH_CTRL_CENTER_SHIFT)) & eTMR_CH_CTRL_CENTER_MASK)
...
#define MPWM_CHN_IRQS                                                         { {MPWM0_Ch0_IRQn, MPWM0_Ch1_IRQn, MPWM0_Ch2_IRQn, MPWM0_Ch3_IRQn, MPWM0_Ch4_IRQn, MPWM0_Ch5_IRQn, MPWM0_Ch6_IRQn, MPWM0_Ch7_IRQn, MPWM0_Ch8_IRQn, MPWM0_Ch9_IRQn, MPWM0_Ch10_IRQn, MPWM0_Ch11_IRQn, MPWM0_Ch12_IRQn, MPWM0_Ch13_IRQn, MPWM0_Ch14_IRQn, MPWM0_Ch15_IRQn} }
/** Number of interrupt channels for the counter overflow interrupt type of MPWM. */
#define MPWM_OVF_IRQS_CH_COUNT                                                (8U)
#define MPWM_OVF_IRQS                                                         { {MPWM0_Ch0_Ovf_IRQn, MPWM0_Ch1_Ovf_IRQn, MPWM0_Ch2_Ovf_IRQn, MPWM0_Ch3_Ovf_IRQn, MPWM0_Ch4_Ovf_IRQn, MPWM0_Ch5_Ovf_IRQn, MPWM0_Ch6_Ovf_IRQn, MPWM0_Ch7_Ovf_IRQn, MPWM0_Ch8_Ovf_IRQn, MPWM0_Ch9_Ovf_IRQn, MPWM0_Ch10_Ovf_IRQn, MPWM0_Ch11_Ovf_IRQn, MPWM0_Ch12_Ovf_IRQn, MPWM0_Ch13_Ovf_IRQn, MPWM0_Ch14_Ovf_IRQn, MPWM0_Ch15_Ovf_IRQn} }

/* MPWM Register Mask */
/* MPWM_IOSTS Register */
#define MPWM_IOSTS_CH15IO_MASK                                                (0x8000U)
#define MPWM_IOSTS_CH15IO_SHIFT                                               (15U)
#define MPWM_IOSTS_CH15IO(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_IOSTS_CH15IO_SHIFT)) & MPWM_IOSTS_CH15IO_MASK)
#define MPWM_IOSTS_CH14IO_MASK                                                (0x4000U)
#define MPWM_IOSTS_CH14IO_SHIFT                                               (14U)
#define MPWM_IOSTS_CH14IO(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_IOSTS_CH14IO_SHIFT)) & MPWM_IOSTS_CH14IO_MASK)
#define MPWM_IOSTS_CH13IO_MASK                                                (0x2000U)
#define MPWM_IOSTS_CH13IO_SHIFT                                               (13U)
#define MPWM_IOSTS_CH13IO(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_IOSTS_CH13IO_SHIFT)) & MPWM_IOSTS_CH13IO_MASK)
#define MPWM_IOSTS_CH12IO_MASK                                                (0x1000U)
#define MPWM_IOSTS_CH12IO_SHIFT                                               (12U)
#define MPWM_IOSTS_CH12IO(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_IOSTS_CH12IO_SHIFT)) & MPWM_IOSTS_CH12IO_MASK)
#define MPWM_IOSTS_CH11IO_MASK                                                (0x800U)
#define MPWM_IOSTS_CH11IO_SHIFT                                               (11U)
#define MPWM_IOSTS_CH11IO(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_IOSTS_CH11IO_SHIFT)) & MPWM_IOSTS_CH11IO_MASK)
#define MPWM_IOSTS_CH10IO_MASK                                                (0x400U)
#define MPWM_IOSTS_CH10IO_SHIFT                                               (10U)
#define MPWM_IOSTS_CH10IO(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_IOSTS_CH10IO_SHIFT)) & MPWM_IOSTS_CH10IO_MASK)
#define MPWM_IOSTS_CH9IO_MASK                                                 (0x200U)
#define MPWM_IOSTS_CH9IO_SHIFT                                                (9U)
#define MPWM_IOSTS_CH9IO(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_IOSTS_CH9IO_SHIFT)) & MPWM_IOSTS_CH9IO_MASK)
#define MPWM_IOSTS_CH8IO_MASK                                                 (0x100U)
#define MPWM_IOSTS_CH8IO_SHIFT                                                (8U)
#define MPWM_IOSTS_CH8IO(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_IOSTS_CH8IO_SHIFT)) & MPWM_IOSTS_CH8IO_MASK)
...
#define MPWM_STS0_CH15TOF(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_STS0_CH15TOF_SHIFT)) & MPWM_STS0_CH15TOF_MASK)
#define MPWM_STS0_CH14TOF_MASK                                                (0x4000U)
#define MPWM_STS0_CH14TOF_SHIFT                                               (14U)
#define MPWM_STS0_CH14TOF(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_STS0_CH14TOF_SHIFT)) & MPWM_STS0_CH14TOF_MASK)
#define MPWM_STS0_CH13TOF_MASK                                                (0x2000U)
#define MPWM_STS0_CH13TOF_SHIFT                                               (13U)
#define MPWM_STS0_CH13TOF(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_STS0_CH13TOF_SHIFT)) & MPWM_STS0_CH13TOF_MASK)
#define MPWM_STS0_CH12TOF_MASK                                                (0x1000U)
#define MPWM_STS0_CH12TOF_SHIFT                                               (12U)
#define MPWM_STS0_CH12TOF(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_STS0_CH12TOF_SHIFT)) & MPWM_STS0_CH12TOF_MASK)
#define MPWM_STS0_CH11TOF_MASK                                                (0x800U)
#define MPWM_STS0_CH11TOF_SHIFT                                               (11U)
#define MPWM_STS0_CH11TOF(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_STS0_CH11TOF_SHIFT)) & MPWM_STS0_CH11TOF_MASK)
#define MPWM_STS0_CH10TOF_MASK                                                (0x400U)
#define MPWM_STS0_CH10TOF_SHIFT                                               (10U)
#define MPWM_STS0_CH10TOF(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_STS0_CH10TOF_SHIFT)) & MPWM_STS0_CH10TOF_MASK)
#define MPWM_STS0_CH9TOF_MASK                                                 (0x200U)
#define MPWM_STS0_CH9TOF_SHIFT                                                (9U)
#define MPWM_STS0_CH9TOF(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_STS0_CH9TOF_SHIFT)) & MPWM_STS0_CH9TOF_MASK)
#define MPWM_STS0_CH8TOF_MASK                                                 (0x100U)
#define MPWM_STS0_CH8TOF_SHIFT                                                (8U)
#define MPWM_STS0_CH8TOF(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_STS0_CH8TOF_SHIFT)) & MPWM_STS0_CH8TOF_MASK)
...
#define MPWM_STS1_CH15F(x)                                                    (((uint32_t)(((uint32_t)(x)) << MPWM_STS1_CH15F_SHIFT)) & MPWM_STS1_CH15F_MASK)
#define MPWM_STS1_CH14F_MASK                                                  (0x4000U)
#define MPWM_STS1_CH14F_SHIFT                                                 (14U)
#define MPWM_STS1_CH14F(x)                                                    (((uint32_t)(((uint32_t)(x)) << MPWM_STS1_CH14F_SHIFT)) & MPWM_STS1_CH14F_MASK)
#define MPWM_STS1_CH13F_MASK                                                  (0x2000U)
#define MPWM_STS1_CH13F_SHIFT                                                 (13U)
#define MPWM_STS1_CH13F(x)                                                    (((uint32_t)(((uint32_t)(x)) << MPWM_STS1_CH13F_SHIFT)) & MPWM_STS1_CH13F_MASK)
#define MPWM_STS1_CH12F_MASK                                                  (0x1000U)
#define MPWM_STS1_CH12F_SHIFT                                                 (12U)
#define MPWM_STS1_CH12F(x)                                                    (((uint32_t)(((uint32_t)(x)) << MPWM_STS1_CH12F_SHIFT)) & MPWM_STS1_CH12F_MASK)
#define MPWM_STS1_CH11F_MASK                                                  (0x800U)
#define MPWM_STS1_CH11F_SHIFT                                                 (11U)
#define MPWM_STS1_CH11F(x)                                                    (((uint32_t)(((uint32_t)(x)) << MPWM_STS1_CH11F_SHIFT)) & MPWM_STS1_CH11F_MASK)
#define MPWM_STS1_CH10F_MASK                                                  (0x400U)
#define MPWM_STS1_CH10F_SHIFT                                                 (10U)
#define MPWM_STS1_CH10F(x)                                                    (((uint32_t)(((uint32_t)(x)) << MPWM_STS1_CH10F_SHIFT)) & MPWM_STS1_CH10F_MASK)
#define MPWM_STS1_CH9F_MASK                                                   (0x200U)
#define MPWM_STS1_CH9F_SHIFT                                                  (9U)
#define MPWM_STS1_CH9F(x)                                                     (((uint32_t)(((uint32_t)(x)) << MPWM_STS1_CH9F_SHIFT)) & MPWM_STS1_CH9F_MASK)
#define MPWM_STS1_CH8F_MASK                                                   (0x100U)
#define MPWM_STS1_CH8F_SHIFT                                                  (8U)
#define MPWM_STS1_CH8F(x)                                                     (((uint32_t)(((uint32_t)(x)) << MPWM_STS1_CH8F_SHIFT)) & MPWM_STS1_CH8F_MASK)
...
#define MPWM_INTE0_CH15TOIE(x)                                                (((uint32_t)(((uint32_t)(x)) << MPWM_INTE0_CH15TOIE_SHIFT)) & MPWM_INTE0_CH15TOIE_MASK)
#define MPWM_INTE0_CH14TOIE_MASK                                              (0x4000U)
#define MPWM_INTE0_CH14TOIE_SHIFT                                             (14U)
#define MPWM_INTE0_CH14TOIE(x)                                                (((uint32_t)(((uint32_t)(x)) << MPWM_INTE0_CH14TOIE_SHIFT)) & MPWM_INTE0_CH14TOIE_MASK)
#define MPWM_INTE0_CH13TOIE_MASK                                              (0x2000U)
#define MPWM_INTE0_CH13TOIE_SHIFT                                             (13U)
#define MPWM_INTE0_CH13TOIE(x)                                                (((uint32_t)(((uint32_t)(x)) << MPWM_INTE0_CH13TOIE_SHIFT)) & MPWM_INTE0_CH13TOIE_MASK)
#define MPWM_INTE0_CH12TOIE_MASK                                              (0x1000U)
#define MPWM_INTE0_CH12TOIE_SHIFT                                             (12U)
#define MPWM_INTE0_CH12TOIE(x)                                                (((uint32_t)(((uint32_t)(x)) << MPWM_INTE0_CH12TOIE_SHIFT)) & MPWM_INTE0_CH12TOIE_MASK)
#define MPWM_INTE0_CH11TOIE_MASK                                              (0x800U)
#define MPWM_INTE0_CH11TOIE_SHIFT                                             (11U)
#define MPWM_INTE0_CH11TOIE(x)                                                (((uint32_t)(((uint32_t)(x)) << MPWM_INTE0_CH11TOIE_SHIFT)) & MPWM_INTE0_CH11TOIE_MASK)
#define MPWM_INTE0_CH10TOIE_MASK                                              (0x400U)
#define MPWM_INTE0_CH10TOIE_SHIFT                                             (10U)
#define MPWM_INTE0_CH10TOIE(x)                                                (((uint32_t)(((uint32_t)(x)) << MPWM_INTE0_CH10TOIE_SHIFT)) & MPWM_INTE0_CH10TOIE_MASK)
#define MPWM_INTE0_CH9TOIE_MASK                                               (0x200U)
#define MPWM_INTE0_CH9TOIE_SHIFT                                              (9U)
#define MPWM_INTE0_CH9TOIE(x)                                                 (((uint32_t)(((uint32_t)(x)) << MPWM_INTE0_CH9TOIE_SHIFT)) & MPWM_INTE0_CH9TOIE_MASK)
#define MPWM_INTE0_CH8TOIE_MASK                                               (0x100U)
#define MPWM_INTE0_CH8TOIE_SHIFT                                              (8U)
#define MPWM_INTE0_CH8TOIE(x)                                                 (((uint32_t)(((uint32_t)(x)) << MPWM_INTE0_CH8TOIE_SHIFT)) & MPWM_INTE0_CH8TOIE_MASK)
...
#define MPWM_INTE1_CH15IE(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_INTE1_CH15IE_SHIFT)) & MPWM_INTE1_CH15IE_MASK)
#define MPWM_INTE1_CH14IE_MASK                                                (0x4000U)
#define MPWM_INTE1_CH14IE_SHIFT                                               (14U)
#define MPWM_INTE1_CH14IE(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_INTE1_CH14IE_SHIFT)) & MPWM_INTE1_CH14IE_MASK)
#define MPWM_INTE1_CH13IE_MASK                                                (0x2000U)
#define MPWM_INTE1_CH13IE_SHIFT                                               (13U)
#define MPWM_INTE1_CH13IE(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_INTE1_CH13IE_SHIFT)) & MPWM_INTE1_CH13IE_MASK)
#define MPWM_INTE1_CH12IE_MASK                                                (0x1000U)
#define MPWM_INTE1_CH12IE_SHIFT                                               (12U)
#define MPWM_INTE1_CH12IE(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_INTE1_CH12IE_SHIFT)) & MPWM_INTE1_CH12IE_MASK)
#define MPWM_INTE1_CH11IE_MASK                                                (0x800U)
#define MPWM_INTE1_CH11IE_SHIFT                                               (11U)
#define MPWM_INTE1_CH11IE(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_INTE1_CH11IE_SHIFT)) & MPWM_INTE1_CH11IE_MASK)
#define MPWM_INTE1_CH10IE_MASK                                                (0x400U)
#define MPWM_INTE1_CH10IE_SHIFT                                               (10U)
#define MPWM_INTE1_CH10IE(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_INTE1_CH10IE_SHIFT)) & MPWM_INTE1_CH10IE_MASK)
#define MPWM_INTE1_CH9IE_MASK                                                 (0x200U)
#define MPWM_INTE1_CH9IE_SHIFT                                                (9U)
#define MPWM_INTE1_CH9IE(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_INTE1_CH9IE_SHIFT)) & MPWM_INTE1_CH9IE_MASK)
#define MPWM_INTE1_CH8IE_MASK                                                 (0x100U)
#define MPWM_INTE1_CH8IE_SHIFT                                                (8U)
#define MPWM_INTE1_CH8IE(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_INTE1_CH8IE_SHIFT)) & MPWM_INTE1_CH8IE_MASK)
...
#define MPWM_CTRL_CLKSRC(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_CTRL_CLKSRC_SHIFT)) & MPWM_CTRL_CLKSRC_MASK)
#define MPWM_CTRL_CH15EN_MASK                                                 (0x8000U)
#define MPWM_CTRL_CH15EN_SHIFT                                                (15U)
#define MPWM_CTRL_CH15EN(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_CTRL_CH15EN_SHIFT)) & MPWM_CTRL_CH15EN_MASK)
#define MPWM_CTRL_CH14EN_MASK                                                 (0x4000U)
#define MPWM_CTRL_CH14EN_SHIFT                                                (14U)
#define MPWM_CTRL_CH14EN(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_CTRL_CH14EN_SHIFT)) & MPWM_CTRL_CH14EN_MASK)
#define MPWM_CTRL_CH13EN_MASK                                                 (0x2000U)
#define MPWM_CTRL_CH13EN_SHIFT                                                (13U)
#define MPWM_CTRL_CH13EN(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_CTRL_CH13EN_SHIFT)) & MPWM_CTRL_CH13EN_MASK)
#define MPWM_CTRL_CH12EN_MASK                                                 (0x1000U)
#define MPWM_CTRL_CH12EN_SHIFT                                                (12U)
#define MPWM_CTRL_CH12EN(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_CTRL_CH12EN_SHIFT)) & MPWM_CTRL_CH12EN_MASK)
#define MPWM_CTRL_CH11EN_MASK                                                 (0x800U)
#define MPWM_CTRL_CH11EN_SHIFT                                                (11U)
#define MPWM_CTRL_CH11EN(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_CTRL_CH11EN_SHIFT)) & MPWM_CTRL_CH11EN_MASK)
#define MPWM_CTRL_CH10EN_MASK                                                 (0x400U)
#define MPWM_CTRL_CH10EN_SHIFT                                                (10U)
#define MPWM_CTRL_CH10EN(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_CTRL_CH10EN_SHIFT)) & MPWM_CTRL_CH10EN_MASK)
#define MPWM_CTRL_CH9EN_MASK                                                  (0x200U)
#define MPWM_CTRL_CH9EN_SHIFT                                                 (9U)
#define MPWM_CTRL_CH9EN(x)                                                    (((uint32_t)(((uint32_t)(x)) << MPWM_CTRL_CH9EN_SHIFT)) & MPWM_CTRL_CH9EN_MASK)
#define MPWM_CTRL_CH8EN_MASK                                                  (0x100U)
#define MPWM_CTRL_CH8EN_SHIFT                                                 (8U)
#define MPWM_CTRL_CH8EN(x)                                                    (((uint32_t)(((uint32_t)(x)) << MPWM_CTRL_CH8EN_SHIFT)) & MPWM_CTRL_CH8EN_MASK)
...
#define MPWM_SWT_CH15SWT(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_SWT_CH15SWT_SHIFT)) & MPWM_SWT_CH15SWT_MASK)
#define MPWM_SWT_CH14SWT_MASK                                                 (0x4000U)
#define MPWM_SWT_CH14SWT_SHIFT                                                (14U)
#define MPWM_SWT_CH14SWT(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_SWT_CH14SWT_SHIFT)) & MPWM_SWT_CH14SWT_MASK)
#define MPWM_SWT_CH13SWT_MASK                                                 (0x2000U)
#define MPWM_SWT_CH13SWT_SHIFT                                                (13U)
#define MPWM_SWT_CH13SWT(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_SWT_CH13SWT_SHIFT)) & MPWM_SWT_CH13SWT_MASK)
#define MPWM_SWT_CH12SWT_MASK                                                 (0x1000U)
#define MPWM_SWT_CH12SWT_SHIFT                                                (12U)
#define MPWM_SWT_CH12SWT(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_SWT_CH12SWT_SHIFT)) & MPWM_SWT_CH12SWT_MASK)
#define MPWM_SWT_CH11SWT_MASK                                                 (0x800U)
#define MPWM_SWT_CH11SWT_SHIFT                                                (11U)
#define MPWM_SWT_CH11SWT(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_SWT_CH11SWT_SHIFT)) & MPWM_SWT_CH11SWT_MASK)
#define MPWM_SWT_CH10SWT_MASK                                                 (0x400U)
#define MPWM_SWT_CH10SWT_SHIFT                                                (10U)
#define MPWM_SWT_CH10SWT(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_SWT_CH10SWT_SHIFT)) & MPWM_SWT_CH10SWT_MASK)
#define MPWM_SWT_CH9SWT_MASK                                                  (0x200U)
#define MPWM_SWT_CH9SWT_SHIFT                                                 (9U)
#define MPWM_SWT_CH9SWT(x)                                                    (((uint32_t)(((uint32_t)(x)) << MPWM_SWT_CH9SWT_SHIFT)) & MPWM_SWT_CH9SWT_MASK)
#define MPWM_SWT_CH8SWT_MASK                                                  (0x100U)
#define MPWM_SWT_CH8SWT_SHIFT                                                 (8U)
#define MPWM_SWT_CH8SWT(x)                                                    (((uint32_t)(((uint32_t)(x)) << MPWM_SWT_CH8SWT_SHIFT)) & MPWM_SWT_CH8SWT_MASK)
...
#define MPWM_INIT_CH15INIT(x)                                                 (((uint32_t)(((uint32_t)(x)) << MPWM_INIT_CH15INIT_SHIFT)) & MPWM_INIT_CH15INIT_MASK)
#define MPWM_INIT_CH14INIT_MASK                                               (0x4000U)
#define MPWM_INIT_CH14INIT_SHIFT                                              (14U)
#define MPWM_INIT_CH14INIT(x)                                                 (((uint32_t)(((uint32_t)(x)) << MPWM_INIT_CH14INIT_SHIFT)) & MPWM_INIT_CH14INIT_MASK)
#define MPWM_INIT_CH13INIT_MASK                                               (0x2000U)
#define MPWM_INIT_CH13INIT_SHIFT                                              (13U)
#define MPWM_INIT_CH13INIT(x)                                                 (((uint32_t)(((uint32_t)(x)) << MPWM_INIT_CH13INIT_SHIFT)) & MPWM_INIT_CH13INIT_MASK)
#define MPWM_INIT_CH12INIT_MASK                                               (0x1000U)
#define MPWM_INIT_CH12INIT_SHIFT                                              (12U)
#define MPWM_INIT_CH12INIT(x)                                                 (((uint32_t)(((uint32_t)(x)) << MPWM_INIT_CH12INIT_SHIFT)) & MPWM_INIT_CH12INIT_MASK)
#define MPWM_INIT_CH11INIT_MASK                                               (0x800U)
#define MPWM_INIT_CH11INIT_SHIFT                                              (11U)
#define MPWM_INIT_CH11INIT(x)                                                 (((uint32_t)(((uint32_t)(x)) << MPWM_INIT_CH11INIT_SHIFT)) & MPWM_INIT_CH11INIT_MASK)
#define MPWM_INIT_CH10INIT_MASK                                               (0x400U)
#define MPWM_INIT_CH10INIT_SHIFT                                              (10U)
#define MPWM_INIT_CH10INIT(x)                                                 (((uint32_t)(((uint32_t)(x)) << MPWM_INIT_CH10INIT_SHIFT)) & MPWM_INIT_CH10INIT_MASK)
#define MPWM_INIT_CH9INIT_MASK                                                (0x200U)
#define MPWM_INIT_CH9INIT_SHIFT                                               (9U)
#define MPWM_INIT_CH9INIT(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_INIT_CH9INIT_SHIFT)) & MPWM_INIT_CH9INIT_MASK)
#define MPWM_INIT_CH8INIT_MASK                                                (0x100U)
#define MPWM_INIT_CH8INIT_SHIFT                                               (8U)
#define MPWM_INIT_CH8INIT(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_INIT_CH8INIT_SHIFT)) & MPWM_INIT_CH8INIT_MASK)
...
#define MPWM_POL_CH15POL(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_POL_CH15POL_SHIFT)) & MPWM_POL_CH15POL_MASK)
#define MPWM_POL_CH14POL_MASK                                                 (0x4000U)
#define MPWM_POL_CH14POL_SHIFT                                                (14U)
#define MPWM_POL_CH14POL(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_POL_CH14POL_SHIFT)) & MPWM_POL_CH14POL_MASK)
#define MPWM_POL_CH13POL_MASK                                                 (0x2000U)
#define MPWM_POL_CH13POL_SHIFT                                                (13U)
#define MPWM_POL_CH13POL(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_POL_CH13POL_SHIFT)) & MPWM_POL_CH13POL_MASK)
#define MPWM_POL_CH12POL_MASK                                                 (0x1000U)
#define MPWM_POL_CH12POL_SHIFT                                                (12U)
#define MPWM_POL_CH12POL(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_POL_CH12POL_SHIFT)) & MPWM_POL_CH12POL_MASK)
#define MPWM_POL_CH11POL_MASK                                                 (0x800U)
#define MPWM_POL_CH11POL_SHIFT                                                (11U)
#define MPWM_POL_CH11POL(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_POL_CH11POL_SHIFT)) & MPWM_POL_CH11POL_MASK)
#define MPWM_POL_CH10POL_MASK                                                 (0x400U)
#define MPWM_POL_CH10POL_SHIFT                                                (10U)
#define MPWM_POL_CH10POL(x)                                                   (((uint32_t)(((uint32_t)(x)) << MPWM_POL_CH10POL_SHIFT)) & MPWM_POL_CH10POL_MASK)
#define MPWM_POL_CH9POL_MASK                                                  (0x200U)
#define MPWM_POL_CH9POL_SHIFT                                                 (9U)
#define MPWM_POL_CH9POL(x)                                                    (((uint32_t)(((uint32_t)(x)) << MPWM_POL_CH9POL_SHIFT)) & MPWM_POL_CH9POL_MASK)
#define MPWM_POL_CH8POL_MASK                                                  (0x100U)
#define MPWM_POL_CH8POL_SHIFT                                                 (8U)
#define MPWM_POL_CH8POL(x)                                                    (((uint32_t)(((uint32_t)(x)) << MPWM_POL_CH8POL_SHIFT)) & MPWM_POL_CH8POL_MASK)
...
#define MPWM_LDOK_CH15LDOK(x)                                                 (((uint32_t)(((uint32_t)(x)) << MPWM_LDOK_CH15LDOK_SHIFT)) & MPWM_LDOK_CH15LDOK_MASK)
#define MPWM_LDOK_CH14LDOK_MASK                                               (0x4000U)
#define MPWM_LDOK_CH14LDOK_SHIFT                                              (14U)
#define MPWM_LDOK_CH14LDOK(x)                                                 (((uint32_t)(((uint32_t)(x)) << MPWM_LDOK_CH14LDOK_SHIFT)) & MPWM_LDOK_CH14LDOK_MASK)
#define MPWM_LDOK_CH13LDOK_MASK                                               (0x2000U)
#define MPWM_LDOK_CH13LDOK_SHIFT                                              (13U)
#define MPWM_LDOK_CH13LDOK(x)                                                 (((uint32_t)(((uint32_t)(x)) << MPWM_LDOK_CH13LDOK_SHIFT)) & MPWM_LDOK_CH13LDOK_MASK)
#define MPWM_LDOK_CH12LDOK_MASK                                               (0x1000U)
#define MPWM_LDOK_CH12LDOK_SHIFT                                              (12U)
#define MPWM_LDOK_CH12LDOK(x)                                                 (((uint32_t)(((uint32_t)(x)) << MPWM_LDOK_CH12LDOK_SHIFT)) & MPWM_LDOK_CH12LDOK_MASK)
#define MPWM_LDOK_CH11LDOK_MASK                                               (0x800U)
#define MPWM_LDOK_CH11LDOK_SHIFT                                              (11U)
#define MPWM_LDOK_CH11LDOK(x)                                                 (((uint32_t)(((uint32_t)(x)) << MPWM_LDOK_CH11LDOK_SHIFT)) & MPWM_LDOK_CH11LDOK_MASK)
#define MPWM_LDOK_CH10LDOK_MASK                                               (0x400U)
#define MPWM_LDOK_CH10LDOK_SHIFT                                              (10U)
#define MPWM_LDOK_CH10LDOK(x)                                                 (((uint32_t)(((uint32_t)(x)) << MPWM_LDOK_CH10LDOK_SHIFT)) & MPWM_LDOK_CH10LDOK_MASK)
#define MPWM_LDOK_CH9LDOK_MASK                                                (0x200U)
#define MPWM_LDOK_CH9LDOK_SHIFT                                               (9U)
#define MPWM_LDOK_CH9LDOK(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_LDOK_CH9LDOK_SHIFT)) & MPWM_LDOK_CH9LDOK_MASK)
#define MPWM_LDOK_CH8LDOK_MASK                                                (0x100U)
#define MPWM_LDOK_CH8LDOK_SHIFT                                               (8U)
#define MPWM_LDOK_CH8LDOK(x)                                                  (((uint32_t)(((uint32_t)(x)) << MPWM_LDOK_CH8LDOK_SHIFT)) & MPWM_LDOK_CH8LDOK_MASK)
...
#define MPWM_CLDOK_CH15CLDOK(x)                                               (((uint32_t)(((uint32_t)(x)) << MPWM_CLDOK_CH15CLDOK_SHIFT)) & MPWM_CLDOK_CH15CLDOK_MASK)
#define MPWM_CLDOK_CH14CLDOK_MASK                                             (0x4000U)
#define MPWM_CLDOK_CH14CLDOK_SHIFT                                            (14U)
#define MPWM_CLDOK_CH14CLDOK(x)                                               (((uint32_t)(((uint32_t)(x)) << MPWM_CLDOK_CH14CLDOK_SHIFT)) & MPWM_CLDOK_CH14CLDOK_MASK)
#define MPWM_CLDOK_CH13CLDOK_MASK                                             (0x2000U)
#define MPWM_CLDOK_CH13CLDOK_SHIFT                                            (13U)
#define MPWM_CLDOK_CH13CLDOK(x)                                               (((uint32_t)(((uint32_t)(x)) << MPWM_CLDOK_CH13CLDOK_SHIFT)) & MPWM_CLDOK_CH13CLDOK_MASK)
#define MPWM_CLDOK_CH12CLDOK_MASK                                             (0x1000U)
#define MPWM_CLDOK_CH12CLDOK_SHIFT                                            (12U)
#define MPWM_CLDOK_CH12CLDOK(x)                                               (((uint32_t)(((uint32_t)(x)) << MPWM_CLDOK_CH12CLDOK_SHIFT)) & MPWM_CLDOK_CH12CLDOK_MASK)
#define MPWM_CLDOK_CH11CLDOK_MASK                                             (0x800U)
#define MPWM_CLDOK_CH11CLDOK_SHIFT                                            (11U)
#define MPWM_CLDOK_CH11CLDOK(x)                                               (((uint32_t)(((uint32_t)(x)) << MPWM_CLDOK_CH11CLDOK_SHIFT)) & MPWM_CLDOK_CH11CLDOK_MASK)
#define MPWM_CLDOK_CH10CLDOK_MASK                                             (0x400U)
#define MPWM_CLDOK_CH10CLDOK_SHIFT                                            (10U)
#define MPWM_CLDOK_CH10CLDOK(x)                                               (((uint32_t)(((uint32_t)(x)) << MPWM_CLDOK_CH10CLDOK_SHIFT)) & MPWM_CLDOK_CH10CLDOK_MASK)
#define MPWM_CLDOK_CH9CLDOK_MASK                                              (0x200U)
#define MPWM_CLDOK_CH9CLDOK_SHIFT                                             (9U)
#define MPWM_CLDOK_CH9CLDOK(x)                                                (((uint32_t)(((uint32_t)(x)) << MPWM_CLDOK_CH9CLDOK_SHIFT)) & MPWM_CLDOK_CH9CLDOK_MASK)
#define MPWM_CLDOK_CH8CLDOK_MASK                                              (0x100U)
#define MPWM_CLDOK_CH8CLDOK_SHIFT                                             (8U)
#define MPWM_CLDOK_CH8CLDOK(x)                                                (((uint32_t)(((uint32_t)(x)) << MPWM_CLDOK_CH8CLDOK_SHIFT)) & MPWM_CLDOK_CH8CLDOK_MASK)
...
#define MPWM_COMBCMP_CH1415COMBSRC(x)                                         (((uint32_t)(((uint32_t)(x)) << MPWM_COMBCMP_CH1415COMBSRC_SHIFT)) & MPWM_COMBCMP_CH1415COMBSRC_MASK)
#define MPWM_COMBCMP_CH1213COMBSRC_MASK                                       (0x400000U)
#define MPWM_COMBCMP_CH1213COMBSRC_SHIFT                                      (22U)
#define MPWM_COMBCMP_CH1213COMBSRC(x)                                         (((uint32_t)(((uint32_t)(x)) << MPWM_COMBCMP_CH1213COMBSRC_SHIFT)) & MPWM_COMBCMP_CH1213COMBSRC_MASK)
#define MPWM_COMBCMP_CH1011COMBSRC_MASK                                       (0x200000U)
#define MPWM_COMBCMP_CH1011COMBSRC_SHIFT                                      (21U)
#define MPWM_COMBCMP_CH1011COMBSRC(x)                                         (((uint32_t)(((uint32_t)(x)) << MPWM_COMBCMP_CH1011COMBSRC_SHIFT)) & MPWM_COMBCMP_CH1011COMBSRC_MASK)
#define MPWM_COMBCMP_CH89COMBSRC_MASK                                         (0x100000U)
#define MPWM_COMBCMP_CH89COMBSRC_SHIFT                                        (20U)
#define MPWM_COMBCMP_CH89COMBSRC(x)                                           (((uint32_t)(((uint32_t)(x)) << MPWM_COMBCMP_CH89COMBSRC_SHIFT)) & MPWM_COMBCMP_CH89COMBSRC_MASK)
...
#define MPWM_COMBCMP_CH1415COMBEN(x)                                          (((uint32_t)(((uint32_t)(x)) << MPWM_COMBCMP_CH1415COMBEN_SHIFT)) & MPWM_COMBCMP_CH1415COMBEN_MASK)
#define MPWM_COMBCMP_CH1213COMBEN_MASK                                        (0x40U)
#define MPWM_COMBCMP_CH1213COMBEN_SHIFT                                       (6U)
#define MPWM_COMBCMP_CH1213COMBEN(x)                                          (((uint32_t)(((uint32_t)(x)) << MPWM_COMBCMP_CH1213COMBEN_SHIFT)) & MPWM_COMBCMP_CH1213COMBEN_MASK)
#define MPWM_COMBCMP_CH1011COMBEN_MASK                                        (0x20U)
#define MPWM_COMBCMP_CH1011COMBEN_SHIFT                                       (5U)
#define MPWM_COMBCMP_CH1011COMBEN(x)                                          (((uint32_t)(((uint32_t)(x)) << MPWM_COMBCMP_CH1011COMBEN_SHIFT)) & MPWM_COMBCMP_CH1011COMBEN_MASK)
#define MPWM_COMBCMP_CH89COMBEN_MASK                                          (0x10U)
#define MPWM_COMBCMP_CH89COMBEN_SHIFT                                         (4U)
#define MPWM_COMBCMP_CH89COMBEN(x)                                            (((uint32_t)(((uint32_t)(x)) << MPWM_COMBCMP_CH89COMBEN_SHIFT)) & MPWM_COMBCMP_CH89COMBEN_MASK)
...
#define MPWM_CH_CAP_CAPEDGE(x)                                                (((uint32_t)(((uint32_t)(x)) << MPWM_CH_CAP_CAPEDGE_SHIFT)) & MPWM_CH_CAP_CAPEDGE_MASK)
...
typedef struct {
    ...
    __IO uint32_t RESERVED1;                                                  /**< RESERVED1, offset: 0x0004 */
...
/** Number of interrupt channels for the seconds interrupt type of RTC. */
...
#define eADC_CHSEL_COUNT                                                      (16U)
#define eADC_WDTH_COUNT                                                       (2U)
#define eADC_DATA_COUNT                                                       (16U)

/* eADC Register Layout Typedef */
typedef struct {
    __IO uint32_t STS;                                                        /**< Status register, offset: 0x0000 */
    __I  uint32_t RESERVED1;                                                  /**< RESERVED1, offset: 0x0004 */
    __IO uint32_t OVRSTS;                                                     /**< Buffer Override status register, offset: 0x0008 */
    __IO uint32_t INTE;                                                       /**< Interrupt Enable Register, offset: 0x000C */
    __IO uint32_t CTRL;                                                       /**< Control Register, offset: 0x0010 */
    __IO uint32_t CFG0;                                                       /**< Configuration 0 Register, offset: 0x0014 */
    __IO uint32_t CFG1;                                                       /**< Configuration 0 Register, offset: 0x0018 */
    __IO uint32_t SMP;                                                        /**< Sampling Register, offset: 0x001C */
    __IO uint8_t  RESERVED8[16];                                              /**< RESERVED8, offset: 0x0020 */
    __IO uint8_t  CHSEL[16];                                                  /**< Channel Configure Register, offset: 0x0030 */
    __IO uint8_t  RESERVED10[16];                                             /**< RESERVED10, offset: 0x0040 */
    __IO uint32_t RESERVED11;                                                 /**< RESERVED11, offset: 0x0050 */
    __IO uint32_t TSC;                                                        /**< Temperature Sensor Coefficient, offset: 0x0054 */
    __IO uint8_t  RESERVED13[40];                                             /**< RESERVED13, offset: 0x0058 */
    __IO uint32_t WDCTRL;                                                     /**< Watchdog Control Register, offset: 0x0080 */
    __IO uint8_t  RESERVED15[12];                                             /**< RESERVED15, offset: 0x0084 */
    __IO uint32_t WDTH[ 2];                                                   /**< Watchdog Threshold Register, offset: 0x0090 */
    __IO uint8_t  RESERVED17[56];                                             /**< RESERVED17, offset: 0x0098 */
    __IO uint32_t DATA[16];                                                   /**< Data Buffer Array, offset: 0x00D0 */
...
/* eADC0  base address */
#define eADC0_BASE                                                            (0x40040000U)
#define eADC0                                                                 ((eADC_Type *)(eADC0_BASE))

/** Array initializer of eADC peripheral base addresses */
#define eADC_BASE_ADDRS                                                       { eADC0_BASE }
/** Array initializer of eADC peripheral base pointers */
#define eADC_BASE_PTRS                                                        { eADC0 }
/** Number of interrupt vector arrays for the eADC module. */
#define eADC_IRQS_ARR_COUNT                                                   (1U)
/** Number of interrupt channels for the eADC. */
#define eADC_IRQS_CH_COUNT                                                    (1U)
/** Interrupt vectors for the eADC peripheral type */
#define eADC_IRQS                                                             { eADC0_IRQn }

/* eADC Register Mask */
/* eADC_STS Register */
#define eADC_STS_WD1_MASK                                                     (0x20000U)
#define eADC_STS_WD1_SHIFT                                                    (17U)
#define eADC_STS_WD1(x)                                                       (((uint32_t)(((uint32_t)(x)) << eADC_STS_WD1_SHIFT)) & eADC_STS_WD1_MASK)
#define eADC_STS_WD0_MASK                                                     (0x10000U)
#define eADC_STS_WD0_SHIFT                                                    (16U)
#define eADC_STS_WD0(x)                                                       (((uint32_t)(((uint32_t)(x)) << eADC_STS_WD0_SHIFT)) & eADC_STS_WD0_MASK)
#define eADC_STS_LOWERR_MASK                                                  (0x40U)
#define eADC_STS_LOWERR_SHIFT                                                 (6U)
#define eADC_STS_LOWERR(x)                                                    (((uint32_t)(((uint32_t)(x)) << eADC_STS_LOWERR_SHIFT)) & eADC_STS_LOWERR_MASK)
#define eADC_STS_LEOSEQ_MASK                                                  (0x20U)
#define eADC_STS_LEOSEQ_SHIFT                                                 (5U)
#define eADC_STS_LEOSEQ(x)                                                    (((uint32_t)(((uint32_t)(x)) << eADC_STS_LEOSEQ_SHIFT)) & eADC_STS_LEOSEQ_MASK)
#define eADC_STS_HEOSEQ_MASK                                                  (0x10U)
#define eADC_STS_HEOSEQ_SHIFT                                                 (4U)
#define eADC_STS_HEOSEQ(x)                                                    (((uint32_t)(((uint32_t)(x)) << eADC_STS_HEOSEQ_SHIFT)) & eADC_STS_HEOSEQ_MASK)
#define eADC_STS_NORERR_MASK                                                  (0x8U)
#define eADC_STS_NORERR_SHIFT                                                 (3U)
#define eADC_STS_NORERR(x)                                                    (((uint32_t)(((uint32_t)(x)) << eADC_STS_NORERR_SHIFT)) & eADC_STS_NORERR_MASK)
#define eADC_STS_EOC_MASK                                                     (0x4U)
#define eADC_STS_EOC_SHIFT                                                    (2U)
#define eADC_STS_EOC(x)                                                       (((uint32_t)(((uint32_t)(x)) << eADC_STS_EOC_SHIFT)) & eADC_STS_EOC_MASK)
#define eADC_STS_EOSMP_MASK                                                   (0x2U)
#define eADC_STS_EOSMP_SHIFT                                                  (1U)
#define eADC_STS_EOSMP(x)                                                     (((uint32_t)(((uint32_t)(x)) << eADC_STS_EOSMP_SHIFT)) & eADC_STS_EOSMP_MASK)
#define eADC_STS_ADRDY_MASK                                                   (0x1U)
#define eADC_STS_ADRDY_SHIFT                                                  (0U)
#define eADC_STS_ADRDY(x)                                                     (((uint32_t)(((uint32_t)(x)) << eADC_STS_ADRDY_SHIFT)) & eADC_STS_ADRDY_MASK)
/* eADC_OVRSTS Register */
#define eADC_OVRSTS_OVR15_MASK                                                (0x8000U)
#define eADC_OVRSTS_OVR15_SHIFT                                               (15U)
#define eADC_OVRSTS_OVR15(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR15_SHIFT)) & eADC_OVRSTS_OVR15_MASK)
#define eADC_OVRSTS_OVR14_MASK                                                (0x4000U)
#define eADC_OVRSTS_OVR14_SHIFT                                               (14U)
#define eADC_OVRSTS_OVR14(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR14_SHIFT)) & eADC_OVRSTS_OVR14_MASK)
#define eADC_OVRSTS_OVR13_MASK                                                (0x2000U)
#define eADC_OVRSTS_OVR13_SHIFT                                               (13U)
#define eADC_OVRSTS_OVR13(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR13_SHIFT)) & eADC_OVRSTS_OVR13_MASK)
#define eADC_OVRSTS_OVR12_MASK                                                (0x1000U)
#define eADC_OVRSTS_OVR12_SHIFT                                               (12U)
#define eADC_OVRSTS_OVR12(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR12_SHIFT)) & eADC_OVRSTS_OVR12_MASK)
#define eADC_OVRSTS_OVR11_MASK                                                (0x800U)
#define eADC_OVRSTS_OVR11_SHIFT                                               (11U)
#define eADC_OVRSTS_OVR11(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR11_SHIFT)) & eADC_OVRSTS_OVR11_MASK)
#define eADC_OVRSTS_OVR10_MASK                                                (0x400U)
#define eADC_OVRSTS_OVR10_SHIFT                                               (10U)
#define eADC_OVRSTS_OVR10(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR10_SHIFT)) & eADC_OVRSTS_OVR10_MASK)
#define eADC_OVRSTS_OVR9_MASK                                                 (0x200U)
#define eADC_OVRSTS_OVR9_SHIFT                                                (9U)
#define eADC_OVRSTS_OVR9(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR9_SHIFT)) & eADC_OVRSTS_OVR9_MASK)
#define eADC_OVRSTS_OVR8_MASK                                                 (0x100U)
#define eADC_OVRSTS_OVR8_SHIFT                                                (8U)
#define eADC_OVRSTS_OVR8(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR8_SHIFT)) & eADC_OVRSTS_OVR8_MASK)
#define eADC_OVRSTS_OVR7_MASK                                                 (0x80U)
#define eADC_OVRSTS_OVR7_SHIFT                                                (7U)
#define eADC_OVRSTS_OVR7(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR7_SHIFT)) & eADC_OVRSTS_OVR7_MASK)
#define eADC_OVRSTS_OVR6_MASK                                                 (0x40U)
#define eADC_OVRSTS_OVR6_SHIFT                                                (6U)
#define eADC_OVRSTS_OVR6(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR6_SHIFT)) & eADC_OVRSTS_OVR6_MASK)
#define eADC_OVRSTS_OVR5_MASK                                                 (0x20U)
#define eADC_OVRSTS_OVR5_SHIFT                                                (5U)
#define eADC_OVRSTS_OVR5(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR5_SHIFT)) & eADC_OVRSTS_OVR5_MASK)
#define eADC_OVRSTS_OVR4_MASK                                                 (0x10U)
#define eADC_OVRSTS_OVR4_SHIFT                                                (4U)
#define eADC_OVRSTS_OVR4(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR4_SHIFT)) & eADC_OVRSTS_OVR4_MASK)
#define eADC_OVRSTS_OVR3_MASK                                                 (0x8U)
#define eADC_OVRSTS_OVR3_SHIFT                                                (3U)
#define eADC_OVRSTS_OVR3(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR3_SHIFT)) & eADC_OVRSTS_OVR3_MASK)
#define eADC_OVRSTS_OVR2_MASK                                                 (0x4U)
#define eADC_OVRSTS_OVR2_SHIFT                                                (2U)
#define eADC_OVRSTS_OVR2(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR2_SHIFT)) & eADC_OVRSTS_OVR2_MASK)
#define eADC_OVRSTS_OVR1_MASK                                                 (0x2U)
#define eADC_OVRSTS_OVR1_SHIFT                                                (1U)
#define eADC_OVRSTS_OVR1(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR1_SHIFT)) & eADC_OVRSTS_OVR1_MASK)
#define eADC_OVRSTS_OVR0_MASK                                                 (0x1U)
#define eADC_OVRSTS_OVR0_SHIFT                                                (0U)
#define eADC_OVRSTS_OVR0(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_OVRSTS_OVR0_SHIFT)) & eADC_OVRSTS_OVR0_MASK)
/* eADC_INTE Register */
#define eADC_INTE_WDIE_MASK                                                   (0x10000U)
#define eADC_INTE_WDIE_SHIFT                                                  (16U)
#define eADC_INTE_WDIE(x)                                                     (((uint32_t)(((uint32_t)(x)) << eADC_INTE_WDIE_SHIFT)) & eADC_INTE_WDIE_MASK)
#define eADC_INTE_LOWERRIE_MASK                                               (0x80U)
#define eADC_INTE_LOWERRIE_SHIFT                                              (7U)
#define eADC_INTE_LOWERRIE(x)                                                 (((uint32_t)(((uint32_t)(x)) << eADC_INTE_LOWERRIE_SHIFT)) & eADC_INTE_LOWERRIE_MASK)
#define eADC_INTE_OVRIE_MASK                                                  (0x40U)
#define eADC_INTE_OVRIE_SHIFT                                                 (6U)
#define eADC_INTE_OVRIE(x)                                                    (((uint32_t)(((uint32_t)(x)) << eADC_INTE_OVRIE_SHIFT)) & eADC_INTE_OVRIE_MASK)
#define eADC_INTE_LEOSEQIE_MASK                                               (0x20U)
#define eADC_INTE_LEOSEQIE_SHIFT                                              (5U)
#define eADC_INTE_LEOSEQIE(x)                                                 (((uint32_t)(((uint32_t)(x)) << eADC_INTE_LEOSEQIE_SHIFT)) & eADC_INTE_LEOSEQIE_MASK)
#define eADC_INTE_HEOSEQIE_MASK                                               (0x10U)
#define eADC_INTE_HEOSEQIE_SHIFT                                              (4U)
#define eADC_INTE_HEOSEQIE(x)                                                 (((uint32_t)(((uint32_t)(x)) << eADC_INTE_HEOSEQIE_SHIFT)) & eADC_INTE_HEOSEQIE_MASK)
#define eADC_INTE_NORERRIE_MASK                                               (0x8U)
#define eADC_INTE_NORERRIE_SHIFT                                              (3U)
#define eADC_INTE_NORERRIE(x)                                                 (((uint32_t)(((uint32_t)(x)) << eADC_INTE_NORERRIE_SHIFT)) & eADC_INTE_NORERRIE_MASK)
#define eADC_INTE_EOCIE_MASK                                                  (0x4U)
#define eADC_INTE_EOCIE_SHIFT                                                 (2U)
#define eADC_INTE_EOCIE(x)                                                    (((uint32_t)(((uint32_t)(x)) << eADC_INTE_EOCIE_SHIFT)) & eADC_INTE_EOCIE_MASK)
#define eADC_INTE_EOSMPIE_MASK                                                (0x2U)
#define eADC_INTE_EOSMPIE_SHIFT                                               (1U)
#define eADC_INTE_EOSMPIE(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_INTE_EOSMPIE_SHIFT)) & eADC_INTE_EOSMPIE_MASK)
#define eADC_INTE_ADRDYIE_MASK                                                (0x1U)
#define eADC_INTE_ADRDYIE_SHIFT                                               (0U)
#define eADC_INTE_ADRDYIE(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_INTE_ADRDYIE_SHIFT)) & eADC_INTE_ADRDYIE_MASK)
/* eADC_CTRL Register */
#define eADC_CTRL_TSEN_MASK                                                   (0x10U)
#define eADC_CTRL_TSEN_SHIFT                                                  (4U)
#define eADC_CTRL_TSEN(x)                                                     (((uint32_t)(((uint32_t)(x)) << eADC_CTRL_TSEN_SHIFT)) & eADC_CTRL_TSEN_MASK)
#define eADC_CTRL_ADSTOP_MASK                                                 (0x8U)
#define eADC_CTRL_ADSTOP_SHIFT                                                (3U)
#define eADC_CTRL_ADSTOP(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_CTRL_ADSTOP_SHIFT)) & eADC_CTRL_ADSTOP_MASK)
#define eADC_CTRL_ADSTART_MASK                                                (0x4U)
#define eADC_CTRL_ADSTART_SHIFT                                               (2U)
#define eADC_CTRL_ADSTART(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_CTRL_ADSTART_SHIFT)) & eADC_CTRL_ADSTART_MASK)
#define eADC_CTRL_ADDIS_MASK                                                  (0x2U)
#define eADC_CTRL_ADDIS_SHIFT                                                 (1U)
#define eADC_CTRL_ADDIS(x)                                                    (((uint32_t)(((uint32_t)(x)) << eADC_CTRL_ADDIS_SHIFT)) & eADC_CTRL_ADDIS_MASK)
#define eADC_CTRL_ADEN_MASK                                                   (0x1U)
#define eADC_CTRL_ADEN_SHIFT                                                  (0U)
#define eADC_CTRL_ADEN(x)                                                     (((uint32_t)(((uint32_t)(x)) << eADC_CTRL_ADEN_SHIFT)) & eADC_CTRL_ADEN_MASK)
/* eADC_CFG0 Register */
#define eADC_CFG0_SEQCFG_MASK                                                 (0xC0000000U)
#define eADC_CFG0_SEQCFG_SHIFT                                                (30U)
#define eADC_CFG0_SEQCFG(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_CFG0_SEQCFG_SHIFT)) & eADC_CFG0_SEQCFG_MASK)
#define eADC_CFG0_HSEQSEL_MASK                                                (0x20000000U)
#define eADC_CFG0_HSEQSEL_SHIFT                                               (29U)
#define eADC_CFG0_HSEQSEL(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_CFG0_HSEQSEL_SHIFT)) & eADC_CFG0_HSEQSEL_MASK)
#define eADC_CFG0_HSEQLEN_MASK                                                (0xF000000U)
#define eADC_CFG0_HSEQLEN_SHIFT                                               (24U)
#define eADC_CFG0_HSEQLEN(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_CFG0_HSEQLEN_SHIFT)) & eADC_CFG0_HSEQLEN_MASK)
#define eADC_CFG0_LPEN_MASK                                                   (0x200000U)
#define eADC_CFG0_LPEN_SHIFT                                                  (21U)
#define eADC_CFG0_LPEN(x)                                                     (((uint32_t)(((uint32_t)(x)) << eADC_CFG0_LPEN_SHIFT)) & eADC_CFG0_LPEN_MASK)
#define eADC_CFG0_AUTOOFF_MASK                                                (0x100000U)
#define eADC_CFG0_AUTOOFF_SHIFT                                               (20U)
#define eADC_CFG0_AUTOOFF(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_CFG0_AUTOOFF_SHIFT)) & eADC_CFG0_AUTOOFF_MASK)
#define eADC_CFG0_ALIGN_MASK                                                  (0x80000U)
#define eADC_CFG0_ALIGN_SHIFT                                                 (19U)
#define eADC_CFG0_ALIGN(x)                                                    (((uint32_t)(((uint32_t)(x)) << eADC_CFG0_ALIGN_SHIFT)) & eADC_CFG0_ALIGN_MASK)
#define eADC_CFG0_MODE_MASK                                                   (0x70000U)
#define eADC_CFG0_MODE_SHIFT                                                  (16U)
#define eADC_CFG0_MODE(x)                                                     (((uint32_t)(((uint32_t)(x)) << eADC_CFG0_MODE_SHIFT)) & eADC_CFG0_MODE_MASK)
#define eADC_CFG0_RES_MASK                                                    (0xC000U)
#define eADC_CFG0_RES_SHIFT                                                   (14U)
#define eADC_CFG0_RES(x)                                                      (((uint32_t)(((uint32_t)(x)) << eADC_CFG0_RES_SHIFT)) & eADC_CFG0_RES_MASK)
#define eADC_CFG0_SFTTEN_MASK                                                 (0x2000U)
#define eADC_CFG0_SFTTEN_SHIFT                                                (13U)
#define eADC_CFG0_SFTTEN(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_CFG0_SFTTEN_SHIFT)) & eADC_CFG0_SFTTEN_MASK)
#define eADC_CFG0_LSEQLEN_MASK                                                (0xF00U)
#define eADC_CFG0_LSEQLEN_SHIFT                                               (8U)
#define eADC_CFG0_LSEQLEN(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_CFG0_LSEQLEN_SHIFT)) & eADC_CFG0_LSEQLEN_MASK)
#define eADC_CFG0_PRS_MASK                                                    (0x78U)
#define eADC_CFG0_PRS_SHIFT                                                   (3U)
#define eADC_CFG0_PRS(x)                                                      (((uint32_t)(((uint32_t)(x)) << eADC_CFG0_PRS_SHIFT)) & eADC_CFG0_PRS_MASK)
#define eADC_CFG0_DMAREQCFG_MASK                                              (0x4U)
#define eADC_CFG0_DMAREQCFG_SHIFT                                             (2U)
#define eADC_CFG0_DMAREQCFG(x)                                                (((uint32_t)(((uint32_t)(x)) << eADC_CFG0_DMAREQCFG_SHIFT)) & eADC_CFG0_DMAREQCFG_MASK)
#define eADC_CFG0_LDMAEN_MASK                                                 (0x2U)
#define eADC_CFG0_LDMAEN_SHIFT                                                (1U)
#define eADC_CFG0_LDMAEN(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_CFG0_LDMAEN_SHIFT)) & eADC_CFG0_LDMAEN_MASK)
#define eADC_CFG0_HDMAEN_MASK                                                 (0x1U)
#define eADC_CFG0_HDMAEN_SHIFT                                                (0U)
#define eADC_CFG0_HDMAEN(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_CFG0_HDMAEN_SHIFT)) & eADC_CFG0_HDMAEN_MASK)
/* eADC_CFG1 Register */
#define eADC_CFG1_SMPAVGE_MASK                                                (0xE0000000U)
#define eADC_CFG1_SMPAVGE_SHIFT                                               (29U)
#define eADC_CFG1_SMPAVGE(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_CFG1_SMPAVGE_SHIFT)) & eADC_CFG1_SMPAVGE_MASK)
#define eADC_CFG1_SWITCHCNT_MASK                                              (0xF0000U)
#define eADC_CFG1_SWITCHCNT_SHIFT                                             (16U)
#define eADC_CFG1_SWITCHCNT(x)                                                (((uint32_t)(((uint32_t)(x)) << eADC_CFG1_SWITCHCNT_SHIFT)) & eADC_CFG1_SWITCHCNT_MASK)
#define eADC_CFG1_STCNT_MASK                                                  (0xFFU)
#define eADC_CFG1_STCNT_SHIFT                                                 (0U)
#define eADC_CFG1_STCNT(x)                                                    (((uint32_t)(((uint32_t)(x)) << eADC_CFG1_STCNT_SHIFT)) & eADC_CFG1_STCNT_MASK)
/* eADC_SMP Register */
#define eADC_SMP_SMP1_MASK                                                    (0xFF00U)
#define eADC_SMP_SMP1_SHIFT                                                   (8U)
#define eADC_SMP_SMP1(x)                                                      (((uint32_t)(((uint32_t)(x)) << eADC_SMP_SMP1_SHIFT)) & eADC_SMP_SMP1_MASK)
#define eADC_SMP_SMP0_MASK                                                    (0xFFU)
#define eADC_SMP_SMP0_SHIFT                                                   (0U)
#define eADC_SMP_SMP0(x)                                                      (((uint32_t)(((uint32_t)(x)) << eADC_SMP_SMP0_SHIFT)) & eADC_SMP_SMP0_MASK)
/* eADC_CHSEL Register */
#define eADC_CHSEL_SMPSEL_MASK                                                (0x80U)
#define eADC_CHSEL_SMPSEL_SHIFT                                               (7U)
#define eADC_CHSEL_SMPSEL(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_CHSEL_SMPSEL_SHIFT)) & eADC_CHSEL_SMPSEL_MASK)
#define eADC_CHSEL_OVRMOD_MASK                                                (0x40U)
#define eADC_CHSEL_OVRMOD_SHIFT                                               (6U)
#define eADC_CHSEL_OVRMOD(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_CHSEL_OVRMOD_SHIFT)) & eADC_CHSEL_OVRMOD_MASK)
#define eADC_CHSEL_CHSEL_MASK                                                 (0x3FU)
#define eADC_CHSEL_CHSEL_SHIFT                                                (0U)
#define eADC_CHSEL_CHSEL(x)                                                   (((uint32_t)(((uint32_t)(x)) << eADC_CHSEL_CHSEL_SHIFT)) & eADC_CHSEL_CHSEL_MASK)
/* eADC_TSC Register */
#define eADC_TSC_COEFF_MASK                                                   (0xFFFU)
#define eADC_TSC_COEFF_SHIFT                                                  (0U)
#define eADC_TSC_COEFF(x)                                                     (((uint32_t)(((uint32_t)(x)) << eADC_TSC_COEFF_SHIFT)) & eADC_TSC_COEFF_MASK)
/* eADC_WDCTRL Register */
#define eADC_WDCTRL_WD1EN_MASK                                                (0x8000U)
#define eADC_WDCTRL_WD1EN_SHIFT                                               (15U)
#define eADC_WDCTRL_WD1EN(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_WDCTRL_WD1EN_SHIFT)) & eADC_WDCTRL_WD1EN_MASK)
#define eADC_WDCTRL_WD1CHSEL_MASK                                             (0x3F00U)
#define eADC_WDCTRL_WD1CHSEL_SHIFT                                            (8U)
#define eADC_WDCTRL_WD1CHSEL(x)                                               (((uint32_t)(((uint32_t)(x)) << eADC_WDCTRL_WD1CHSEL_SHIFT)) & eADC_WDCTRL_WD1CHSEL_MASK)
#define eADC_WDCTRL_WD0EN_MASK                                                (0x80U)
#define eADC_WDCTRL_WD0EN_SHIFT                                               (7U)
#define eADC_WDCTRL_WD0EN(x)                                                  (((uint32_t)(((uint32_t)(x)) << eADC_WDCTRL_WD0EN_SHIFT)) & eADC_WDCTRL_WD0EN_MASK)
#define eADC_WDCTRL_WD0SGL_MASK                                               (0x40U)
#define eADC_WDCTRL_WD0SGL_SHIFT                                              (6U)
#define eADC_WDCTRL_WD0SGL(x)                                                 (((uint32_t)(((uint32_t)(x)) << eADC_WDCTRL_WD0SGL_SHIFT)) & eADC_WDCTRL_WD0SGL_MASK)
#define eADC_WDCTRL_WD0CHSEL_MASK                                             (0x3FU)
#define eADC_WDCTRL_WD0CHSEL_SHIFT                                            (0U)
#define eADC_WDCTRL_WD0CHSEL(x)                                               (((uint32_t)(((uint32_t)(x)) << eADC_WDCTRL_WD0CHSEL_SHIFT)) & eADC_WDCTRL_WD0CHSEL_MASK)
/* eADC_WDTH Register */
#define eADC_WDTH_THMD_MASK                                                   (0x80000000U)
#define eADC_WDTH_THMD_SHIFT                                                  (31U)
#define eADC_WDTH_THMD(x)                                                     (((uint32_t)(((uint32_t)(x)) << eADC_WDTH_THMD_SHIFT)) & eADC_WDTH_THMD_MASK)
#define eADC_WDTH_HIGH_MASK                                                   (0xFFF0000U)
#define eADC_WDTH_HIGH_SHIFT                                                  (16U)
#define eADC_WDTH_HIGH(x)                                                     (((uint32_t)(((uint32_t)(x)) << eADC_WDTH_HIGH_SHIFT)) & eADC_WDTH_HIGH_MASK)
#define eADC_WDTH_LOW_MASK                                                    (0xFFFU)
#define eADC_WDTH_LOW_SHIFT                                                   (0U)
#define eADC_WDTH_LOW(x)                                                      (((uint32_t)(((uint32_t)(x)) << eADC_WDTH_LOW_SHIFT)) & eADC_WDTH_LOW_MASK)
/* eADC_DATA Register */
#define eADC_DATA_DB_MASK                                                     (0xFFFFU)
#define eADC_DATA_DB_SHIFT                                                    (0U)
#define eADC_DATA_DB(x)                                                       (((uint32_t)(((uint32_t)(x)) << eADC_DATA_DB_SHIFT)) & eADC_DATA_DB_MASK)
...
/** Number of interrupt channels for the TRNG_INT type of TRNG. */
#define TRNG_TRNG_INT_IRQS_CH_COUNT                                           (1U)
#define TRNG_TRNG_INT_IRQS                                                    { TRNG_IRQn }
...
typedef struct {
    ...
    __IO uint8_t  RESERVED4[240];                                             /**< RESERVED4, offset: 0x0020 */
    __IO uint32_t ERIE;                                                       /**< Error Report Interrupt Enable Register, offset: 0x0110 */
    __IO uint32_t ERIF;                                                       /**< Error Report Interrupt Flag Register, offset: 0x0114 */
    struct {
        __I  uint32_t ADDR;                                                   /**< Error Report Address Register, offset: 0x0118 */
        __I  uint32_t SYND;                                                   /**< Error Report Syndrome Register, offset: 0x011C */
        __IO uint32_t CNT;                                                    /**< Correctable Error Count Register, offset: 0x0120 */
        __IO uint32_t RESERVEDS73;                                            /**< RESERVEDS73, offset: 0x0124 */
...
/** Number of interrupt channels for the EMU Single Bit ECC IRQ type of EMU. */
#define EMU_SB_IRQS_CH_COUNT                                                  (1U)
#define EMU_SB_IRQS                                                           { EMU0_SB_IRQn }
/** Number of interrupt channels for the EMU Double Bits ECC IRQ type of EMU. */
...
#define CMU_CMP_COUNT                                                         (8U)
#define CMU_REFCNTTGT_COUNT                                                   (8U)
#define CMU_CLKVLDDLY_COUNT                                                   (8U)

/* CMU Register Layout Typedef */
typedef struct {
    __IO uint32_t CTRL;                                                       /**< Clock Monitor Unit Control Register, offset: 0x0000 */
    __IO uint32_t STS;                                                        /**< Clock Monitor Unit Status Register, offset: 0x0004 */
    struct {
        __IO uint32_t HIGH;                                                   /**< Clock Monitor Unit High Comparison Value Register, offset: 0x0008 */
        __IO uint32_t LOW;                                                    /**< Clock Monitor Unit Low Comparison Value Register, offset: 0x000C */

    } CMP[8];
    __IO uint32_t REFCNTTGT[ 8];                                              /**< Reference Clock Counter Target Value Register, offset: 0x0048 */
    __IO uint8_t  RESERVED4[ 4];                                              /**< RESERVED4, offset: 0x0068 */
    __I  uint32_t RESERVED5[ 8];                                              /**< RESERVED5, offset: 0x006C */
    __IO uint32_t CLKVLDDLY[ 8];                                              /**< Monitored Clock Valid Delay Limitation Select Register, offset: 0x008C */
...
#define CMU_CTRL_REFS(x)                                                      (((uint32_t)(((uint32_t)(x)) << CMU_CTRL_REFS_SHIFT)) & CMU_CTRL_REFS_MASK)
#define CMU_CTRL_RE_MASK                                                      (0xFF00U)
#define CMU_CTRL_RE_SHIFT                                                     (8U)
#define CMU_CTRL_RE(x)                                                        (((uint32_t)(((uint32_t)(x)) << CMU_CTRL_RE_SHIFT)) & CMU_CTRL_RE_MASK)
#define CMU_CTRL_EN_MASK                                                      (0xFFU)
#define CMU_CTRL_EN_SHIFT                                                     (0U)
#define CMU_CTRL_EN(x)                                                        (((uint32_t)(((uint32_t)(x)) << CMU_CTRL_EN_SHIFT)) & CMU_CTRL_EN_MASK)
/* CMU_STS Register */
#define CMU_STS_LOSV_MASK                                                     (0xFF000000U)
#define CMU_STS_LOSV_SHIFT                                                    (24U)
#define CMU_STS_LOSV(x)                                                       (((uint32_t)(((uint32_t)(x)) << CMU_STS_LOSV_SHIFT)) & CMU_STS_LOSV_MASK)
#define CMU_STS_LOSC_MASK                                                     (0xFF0000U)
#define CMU_STS_LOSC_SHIFT                                                    (16U)
#define CMU_STS_LOSC(x)                                                       (((uint32_t)(((uint32_t)(x)) << CMU_STS_LOSC_SHIFT)) & CMU_STS_LOSC_MASK)
#define CMU_STS_LOSR_MASK                                                     (0xFF00U)
#define CMU_STS_LOSR_SHIFT                                                    (8U)
#define CMU_STS_LOSR(x)                                                       (((uint32_t)(((uint32_t)(x)) << CMU_STS_LOSR_SHIFT)) & CMU_STS_LOSR_MASK)
#define CMU_STS_OUTRNG_MASK                                                   (0xFFU)
#define CMU_STS_OUTRNG_SHIFT                                                  (0U)
#define CMU_STS_OUTRNG(x)                                                     (((uint32_t)(((uint32_t)(x)) << CMU_STS_OUTRNG_SHIFT)) & CMU_STS_OUTRNG_MASK)
/* CMU_CMP_HIGH Register */
#define CMU_CMP_HIGH_VAL_MASK                                                 (0xFFFFU)
#define CMU_CMP_HIGH_VAL_SHIFT                                                (0U)
#define CMU_CMP_HIGH_VAL(x)                                                   (((uint32_t)(((uint32_t)(x)) << CMU_CMP_HIGH_VAL_SHIFT)) & CMU_CMP_HIGH_VAL_MASK)
/* CMU_CMP_LOW Register */
#define CMU_CMP_LOW_VAL_MASK                                                  (0xFFFFU)
#define CMU_CMP_LOW_VAL_SHIFT                                                 (0U)
#define CMU_CMP_LOW_VAL(x)                                                    (((uint32_t)(((uint32_t)(x)) << CMU_CMP_LOW_VAL_SHIFT)) & CMU_CMP_LOW_VAL_MASK)

/* CMU_REFCNTTGT Register */
#define CMU_REFCNTTGT_VAL_MASK                                                (0xFFU)
#define CMU_REFCNTTGT_VAL_SHIFT                                               (0U)
#define CMU_REFCNTTGT_VAL(x)                                                  (((uint32_t)(((uint32_t)(x)) << CMU_REFCNTTGT_VAL_SHIFT)) & CMU_REFCNTTGT_VAL_MASK)
/* CMU_CLKVLDDLY Register */
#define CMU_CLKVLDDLY_VAL_MASK                                                (0xFU)
#define CMU_CLKVLDDLY_VAL_SHIFT                                               (0U)
#define CMU_CLKVLDDLY_VAL(x)                                                  (((uint32_t)(((uint32_t)(x)) << CMU_CLKVLDDLY_VAL_SHIFT)) & CMU_CLKVLDDLY_VAL_MASK)
...
typedef struct {
    __IO uint32_t CTRL;                                                       /**< Control Register, offset: 0x0000 */
    __IO uint32_t CLK_CNT;                                                    /**< Clock Count Register, offset: 0x0004 */
    __IO uint32_t REFCLK_CNT;                                                 /**< Reference Clock Count Register, offset: 0x0008 */
    __IO uint32_t CLK_TGTCNT;                                                 /**< Target Count of to-be-measured Clock Register, offset: 0x000C */
    __IO uint32_t REFCLK_TGTCNT;                                              /**< Reference Clock Target Count Register, offset: 0x0010 */
    __I  uint32_t STS;                                                        /**< Status Register, offset: 0x0014 */
    __I  uint32_t REFCLK_CNT_SAVED;                                           /**< Reference Clock Count Saved Register, offset: 0x0018 */
...
/* CFMU0  base address */
#define CFMU0_BASE                                                            (0x40077000U)
#define CFMU0                                                                 ((CFMU_Type *)(CFMU0_BASE))

/** Array initializer of CFMU peripheral base addresses */
#define CFMU_BASE_ADDRS                                                       { CFMU0_BASE }
...
#define CFMU_CTRL_CLK_OUTEN(x)                                                (((uint32_t)(((uint32_t)(x)) << CFMU_CTRL_CLK_OUTEN_SHIFT)) & CFMU_CTRL_CLK_OUTEN_MASK)
#define CFMU_CTRL_CLK_SEL_MASK                                                (0x7F00U)
#define CFMU_CTRL_CLK_SEL_SHIFT                                               (8U)
#define CFMU_CTRL_CLK_SEL(x)                                                  (((uint32_t)(((uint32_t)(x)) << CFMU_CTRL_CLK_SEL_SHIFT)) & CFMU_CTRL_CLK_SEL_MASK)
#define CFMU_CTRL_CLK_DIV_MASK                                                (0xFFU)
#define CFMU_CTRL_CLK_DIV_SHIFT                                               (0U)
#define CFMU_CTRL_CLK_DIV(x)                                                  (((uint32_t)(((uint32_t)(x)) << CFMU_CTRL_CLK_DIV_SHIFT)) & CFMU_CTRL_CLK_DIV_MASK)
/* CFMU_CLK_CNT Register */
#define CFMU_CLK_CNT_CNT_MASK                                                 (0xFFFFU)
#define CFMU_CLK_CNT_CNT_SHIFT                                                (0U)
#define CFMU_CLK_CNT_CNT(x)                                                   (((uint32_t)(((uint32_t)(x)) << CFMU_CLK_CNT_CNT_SHIFT)) & CFMU_CLK_CNT_CNT_MASK)
/* CFMU_REFCLK_CNT Register */
#define CFMU_REFCLK_CNT_CNT_MASK                                              (0xFFFFU)
#define CFMU_REFCLK_CNT_CNT_SHIFT                                             (0U)
#define CFMU_REFCLK_CNT_CNT(x)                                                (((uint32_t)(((uint32_t)(x)) << CFMU_REFCLK_CNT_CNT_SHIFT)) & CFMU_REFCLK_CNT_CNT_MASK)
/* CFMU_CLK_TGTCNT Register */
#define CFMU_CLK_TGTCNT_CNT_MASK                                              (0xFFFFU)
#define CFMU_CLK_TGTCNT_CNT_SHIFT                                             (0U)
#define CFMU_CLK_TGTCNT_CNT(x)                                                (((uint32_t)(((uint32_t)(x)) << CFMU_CLK_TGTCNT_CNT_SHIFT)) & CFMU_CLK_TGTCNT_CNT_MASK)
/* CFMU_REFCLK_TGTCNT Register */
#define CFMU_REFCLK_TGTCNT_CNT_MASK                                           (0xFFFFU)
#define CFMU_REFCLK_TGTCNT_CNT_SHIFT                                          (0U)
#define CFMU_REFCLK_TGTCNT_CNT(x)                                             (((uint32_t)(((uint32_t)(x)) << CFMU_REFCLK_TGTCNT_CNT_SHIFT)) & CFMU_REFCLK_TGTCNT_CNT_MASK)
/* CFMU_STS Register */
#define CFMU_STS_CLK_CNT_START_MASK                                           (0x4U)
#define CFMU_STS_CLK_CNT_START_SHIFT                                          (2U)
#define CFMU_STS_CLK_CNT_START(x)                                             (((uint32_t)(((uint32_t)(x)) << CFMU_STS_CLK_CNT_START_SHIFT)) & CFMU_STS_CLK_CNT_START_MASK)
#define CFMU_STS_CLK_CNT_STOP_MASK                                            (0x2U)
#define CFMU_STS_CLK_CNT_STOP_SHIFT                                           (1U)
#define CFMU_STS_CLK_CNT_STOP(x)                                              (((uint32_t)(((uint32_t)(x)) << CFMU_STS_CLK_CNT_STOP_SHIFT)) & CFMU_STS_CLK_CNT_STOP_MASK)
#define CFMU_STS_REFCLK_CNT_STOP_MASK                                         (0x1U)
#define CFMU_STS_REFCLK_CNT_STOP_SHIFT                                        (0U)
#define CFMU_STS_REFCLK_CNT_STOP(x)                                           (((uint32_t)(((uint32_t)(x)) << CFMU_STS_REFCLK_CNT_STOP_SHIFT)) & CFMU_STS_REFCLK_CNT_STOP_MASK)
/* CFMU_REFCLK_CNT_SAVED Register */
#define CFMU_REFCLK_CNT_SAVED_CNT_MASK                                        (0xFFFFU)
#define CFMU_REFCLK_CNT_SAVED_CNT_SHIFT                                       (0U)
#define CFMU_REFCLK_CNT_SAVED_CNT(x)                                          (((uint32_t)(((uint32_t)(x)) << CFMU_REFCLK_CNT_SAVED_CNT_SHIFT)) & CFMU_REFCLK_CNT_SAVED_CNT_MASK)
...
/* ----------------------------------------------------------------------------
   -- Backward Compatibility for YTM32B1MD2
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup Backward_Compatibility_Symbols_YTM32B1MD2 Backward Compatibility for YTM32B1MD2
 * @{
 */
...
/*!
 * @}
 */ /* end of group Backward_Compatibility_Symbols_YTM32B1MD2 */
